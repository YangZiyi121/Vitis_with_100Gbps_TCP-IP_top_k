    ...
    wire [8:0] in_chan_dep_data_vec_6;
    ...
    scatter_hls_deadlock_detect_unit #(9, 0, 2, 2) scatter_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~entry_proc_U0.runExperiment_c_blk_n) | (~entry_proc_U0.regBasePort_c_blk_n) | (~entry_proc_U0.usePort_c_blk_n);
    ...
    assign in_chan_dep_data_vec_0[8 : 0] = dep_chan_data_5_0;
    ...
    scatter_hls_deadlock_detect_unit #(9, 1, 1, 1) scatter_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~openStatus_handler_U0.openConStatusBuffer_blk_n);
    ...
    // Process: txStatus_handler_U0
    scatter_hls_deadlock_detect_unit #(9, 2, 1, 1) scatter_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~txStatus_handler_U0.txStatusBuffer_blk_n);
    ...
    scatter_hls_deadlock_detect_unit #(9, 3, 1, 1) scatter_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~txDataBuffer_handler_512_U0.txDataBuffer_blk_n);
    ...
    assign in_chan_dep_data_vec_3[8 : 0] = dep_chan_data_5_3;
    ...
    scatter_hls_deadlock_detect_unit #(9, 4, 1, 1) scatter_hls_deadlock_detect_unit_4 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~rxDataBuffer_handler_512_U0.rxDataBuffer_blk_n);
    ...
    scatter_hls_deadlock_detect_unit #(9, 5, 6, 6) scatter_hls_deadlock_detect_unit_5 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_5_data_FIFO_blk[1] = 1'b0 | (~client_512_U0.openConStatusBuffer_blk_n);
    ...
    assign proc_5_data_FIFO_blk[2] = 1'b0 | (~client_512_U0.txMetaDataBuffer_blk_n);
    ...
    assign proc_5_data_FIFO_blk[3] = 1'b0 | (~client_512_U0.txStatusBuffer_blk_n);
    ...
    assign proc_5_data_FIFO_blk[4] = 1'b0 | (~client_512_U0.txDataBuffer_blk_n);
    ...
    assign proc_5_data_FIFO_blk[5] = 1'b0 | (~client_512_U0.closeConnectionBuffer_blk_n);
    ...
    scatter_hls_deadlock_detect_unit #(9, 6, 1, 1) scatter_hls_deadlock_detect_unit_6 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_6_data_FIFO_blk[0] = 1'b0 | (~txMetaData_handler_U0.txMetaDataBuffer_blk_n);
    ...
    // Process: closeConnection_handler_U0
    scatter_hls_deadlock_detect_unit #(9, 7, 1, 1) scatter_hls_deadlock_detect_unit_7 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_7_data_FIFO_blk[0] = 1'b0 | (~closeConnection_handler_U0.closeConnectionBuffer_blk_n);
    ...
    scatter_hls_deadlock_detect_unit #(9, 8, 2, 2) scatter_hls_deadlock_detect_unit_8 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_8_data_FIFO_blk[0] = 1'b0 | (~server_512_U0.runExperiment_blk_n) | (~server_512_U0.usePort_blk_n) | (~server_512_U0.regBasePort_blk_n);
    ...
    assign proc_8_data_FIFO_blk[1] = 1'b0 | (~server_512_U0.rxDataBuffer_blk_n);
...
`include "scatter_hls_deadlock_report_unit.vh"
