; ModuleID = '/home/yangz0e/Desktop/Vitis_with_100Gbps_TCP-IP_top_k/build/kernel/user_krnl/scatter_krnl/src/hls/scatter_prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_scatter_ir(%"class.hls::stream<ap_uint<16>, 0>"* %listenPort, %"struct.ssdm_int<1, false>"* %listenPortStatus, %"class.hls::stream<appNotification, 0>"* %notifications, %"class.hls::stream<appTxMeta, 0>"* %readRequest, %"class.hls::stream<ap_uint<16>, 0>"* %rxMetaData, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* %rxData, %"class.hls::stream<ipTuple, 0>"* %openConnection, %"class.hls::stream<openStatus, 0>"* %openConStatus, %"class.hls::stream<ap_uint<16>, 0>"* %closeConnection, %"class.hls::stream<appTxMeta, 0>"* %txMetaData, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* %txData, %"class.hls::stream<appTxRsp, 0>"* %txStatus, %"struct.ap_uint<1>"* nocapture readonly %runExperiment, %"struct.ap_uint<16>"* nocapture readonly %useConn, %"struct.ap_uint<16>"* nocapture readonly %useIpAddr, %"struct.ap_uint<16>"* nocapture readonly %pkgWordCount, %"struct.ap_uint<16>"* nocapture readonly %regBasePort, %"struct.ap_uint<16>"* nocapture readonly %usePort, %"struct.ap_uint<16>"* nocapture readonly %expectedRespInKB, %"struct.ap_uint<1>"* nocapture readonly %finishExperiment, %"struct.ap_uint<32>"* nocapture readonly %clientPkgNum, %"struct.ap_uint<32>"* nocapture readonly %regIpAddress0, %"struct.ap_uint<32>"* nocapture readonly %regIpAddress1, %"struct.ap_uint<32>"* nocapture readonly %regIpAddress2, %"struct.ap_uint<32>"* nocapture readonly %regIpAddress3, %"struct.ap_uint<32>"* nocapture readonly %regIpAddress4, %"struct.ap_uint<32>"* nocapture readonly %regIpAddress5, %"struct.ap_uint<32>"* nocapture readonly %regIpAddress6, %"struct.ap_uint<32>"* nocapture readonly %regIpAddress7, %"struct.ap_uint<32>"* nocapture readonly %regIpAddress8, %"struct.ap_uint<32>"* nocapture readonly %regIpAddress9, %"struct.ap_uint<32>"* nocapture readonly %regIpAddress10) local_unnamed_addr #1 {
entry:
  ...
  %listenPortStatus_copy = alloca %"struct.ssdm_int<1, false>", align 512
  call void @llvm.sideeffect() #0 [ "stream_interface"(%"struct.ssdm_int<1, false>"* %listenPortStatus_copy) ]
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0struct.ssdm_int<1, false>"(%"struct.ssdm_int<1, false>"* align 512 %3, %"struct.ssdm_int<1, false>"* %2)
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>.252"(i512* %_V_data_V, i64* %_V_keep_V, i64* %_V_strb_V, i1* %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* %10)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ipTuple, 0>"(i48* align 512 %12, %"class.hls::stream<ipTuple, 0>"* %11)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<openStatus, 0>.214"(i72* align 512 %14, %"class.hls::stream<openStatus, 0>"* %13)
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>.252"(i512* %_V_data_V1, i64* %_V_keep_V2, i64* %_V_strb_V3, i1* %_V_last_V4, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* %19)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<appTxRsp, 0>.231"(i64* align 512 %21, %"class.hls::stream<appTxRsp, 0>"* %20)
  ret void
}
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0struct.ssdm_int<1, false>"(%"struct.ssdm_int<1, false>"* %2, %"struct.ssdm_int<1, false>"* align 512 %3)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<appNotification, 0>.174"(%"class.hls::stream<appNotification, 0>"* %4, i88* align 512 %5)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<appTxMeta, 0>.195"(%"class.hls::stream<appTxMeta, 0>"* %6, i32* align 512 %7)
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ipTuple, 0>.202"(%"class.hls::stream<ipTuple, 0>"* %11, i48* align 512 %12)
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<appTxMeta, 0>.195"(%"class.hls::stream<appTxMeta, 0>"* %17, i32* align 512 %18)
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<appNotification, 0>.174"(%"class.hls::stream<appNotification, 0>"* noalias "fpga.caller.interfaces"="layout_transformed", i88* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #3 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<appNotification, 0>.177"(%"class.hls::stream<appNotification, 0>"* nonnull %0, i88* nonnull align 512 %1)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<appNotification, 0>.177"(%"class.hls::stream<appNotification, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed", i88* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
  %2 = alloca i88
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<appTxMeta, 0>.189"(i32* nonnull align 512 %0, %"class.hls::stream<appTxMeta, 0>"* nonnull %1)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<appTxMeta, 0>.189"(i32* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<appTxMeta, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<appTxMeta, 0>.195"(%"class.hls::stream<appTxMeta, 0>"* noalias "fpga.caller.interfaces"="layout_transformed", i32* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #3 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<appTxMeta, 0>.198"(%"class.hls::stream<appTxMeta, 0>"* nonnull %0, i32* nonnull align 512 %1)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<appTxMeta, 0>.198"(%"class.hls::stream<appTxMeta, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed", i32* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
  %2 = alloca i32
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<ipTuple, 0>.202"(%"class.hls::stream<ipTuple, 0>"* noalias "fpga.caller.interfaces"="layout_transformed", i48* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #3 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<ipTuple, 0>.205"(%"class.hls::stream<ipTuple, 0>"* nonnull %0, i48* nonnull align 512 %1)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<ipTuple, 0>.205"(%"class.hls::stream<ipTuple, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed", i48* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
  %2 = alloca i48
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<openStatus, 0>.214"(i72* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<openStatus, 0>"* noalias "fpga.caller.interfaces"="layout_transformed") unnamed_addr #3 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<openStatus, 0>.217"(i72* nonnull align 512 %0, %"class.hls::stream<openStatus, 0>"* nonnull %1)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<openStatus, 0>.217"(i72* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<openStatus, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<appTxRsp, 0>.231"(i64* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<appTxRsp, 0>"* noalias "fpga.caller.interfaces"="layout_transformed") unnamed_addr #3 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<appTxRsp, 0>.234"(i64* nonnull align 512 %0, %"class.hls::stream<appTxRsp, 0>"* nonnull %1)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<appTxRsp, 0>.234"(i64* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<appTxRsp, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>.246"(%"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* nonnull align 512 %0, i512* %_V_data_V, i64* %_V_keep_V, i64* %_V_strb_V, i1* %_V_last_V)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>.246"(%"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed", i512* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.0" %_V_data_V, i64* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.1" %_V_keep_V, i64* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.2" %_V_strb_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.3" %_V_last_V) unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>.252"(i512* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.0" %_V_data_V, i64* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.1" %_V_keep_V, i64* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.2" %_V_strb_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.3" %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* noalias "fpga.caller.interfaces"="layout_transformed") unnamed_addr #3 {
entry:
  %1 = icmp eq %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* %0, null
  %2 = or i1 false, %1
  br i1 %2, label %ret, label %copy
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>.255"(i512* %_V_data_V, i64* %_V_keep_V, i64* %_V_strb_V, i1* %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* nonnull %0)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>.255"(i512* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.0" %_V_data_V, i64* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.1" %_V_keep_V, i64* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.2" %_V_strb_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.3" %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
  %1 = alloca %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"
...
declare void @apatb_scatter_hw(%"class.hls::stream<ap_uint<16>, 0>"*, %"struct.ssdm_int<1, false>"*, i88*, i32*, %"class.hls::stream<ap_uint<16>, 0>"*, i512*, i64*, i64*, i1*, i48*, i72*, %"class.hls::stream<ap_uint<16>, 0>"*, i32*, i512*, i64*, i64*, i1*, i64*, %"struct.ap_uint<1>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<1>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*)

define void @scatter_hw_stub_wrapper(%"class.hls::stream<ap_uint<16>, 0>"*, %"struct.ssdm_int<1, false>"*, i88*, i32*, %"class.hls::stream<ap_uint<16>, 0>"*, i512*, i64*, i64*, i1*, i48*, i72*, %"class.hls::stream<ap_uint<16>, 0>"*, i32*, i512*, i64*, i64*, i1*, i64*, %"struct.ap_uint<1>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<1>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*) #7 {
entry:
  %38 = alloca %"class.hls::stream<appNotification, 0>"
  %39 = alloca %"class.hls::stream<appTxMeta, 0>"
  %40 = alloca %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"
  %41 = alloca %"class.hls::stream<ipTuple, 0>"
  %42 = alloca %"class.hls::stream<openStatus, 0>"
  %43 = alloca %"class.hls::stream<appTxMeta, 0>"
  %44 = alloca %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"
  %45 = alloca %"class.hls::stream<appTxRsp, 0>"
  call void @copy_out(%"class.hls::stream<ap_uint<16>, 0>"* null, %"class.hls::stream<ap_uint<16>, 0>"* %0, %"struct.ssdm_int<1, false>"* null, %"struct.ssdm_int<1, false>"* %1, %"class.hls::stream<appNotification, 0>"* %38, i88* %2, %"class.hls::stream<appTxMeta, 0>"* %39, i32* %3, %"class.hls::stream<ap_uint<16>, 0>"* null, %"class.hls::stream<ap_uint<16>, 0>"* %4, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* %40, i512* %5, i64* %6, i64* %7, i1* %8, %"class.hls::stream<ipTuple, 0>"* %41, i48* %9, %"class.hls::stream<openStatus, 0>"* %42, i72* %10, %"class.hls::stream<ap_uint<16>, 0>"* null, %"class.hls::stream<ap_uint<16>, 0>"* %11, %"class.hls::stream<appTxMeta, 0>"* %43, i32* %12, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* %44, i512* %13, i64* %14, i64* %15, i1* %16, %"class.hls::stream<appTxRsp, 0>"* %45, i64* %17)
  call void @scatter_hw_stub(%"class.hls::stream<ap_uint<16>, 0>"* %0, %"struct.ssdm_int<1, false>"* %1, %"class.hls::stream<appNotification, 0>"* %38, %"class.hls::stream<appTxMeta, 0>"* %39, %"class.hls::stream<ap_uint<16>, 0>"* %4, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* %40, %"class.hls::stream<ipTuple, 0>"* %41, %"class.hls::stream<openStatus, 0>"* %42, %"class.hls::stream<ap_uint<16>, 0>"* %11, %"class.hls::stream<appTxMeta, 0>"* %43, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* %44, %"class.hls::stream<appTxRsp, 0>"* %45, %"struct.ap_uint<1>"* %18, %"struct.ap_uint<16>"* %19, %"struct.ap_uint<16>"* %20, %"struct.ap_uint<16>"* %21, %"struct.ap_uint<16>"* %22, %"struct.ap_uint<16>"* %23, %"struct.ap_uint<16>"* %24, %"struct.ap_uint<1>"* %25, %"struct.ap_uint<32>"* %26, %"struct.ap_uint<32>"* %27, %"struct.ap_uint<32>"* %28, %"struct.ap_uint<32>"* %29, %"struct.ap_uint<32>"* %30, %"struct.ap_uint<32>"* %31, %"struct.ap_uint<32>"* %32, %"struct.ap_uint<32>"* %33, %"struct.ap_uint<32>"* %34, %"struct.ap_uint<32>"* %35, %"struct.ap_uint<32>"* %36, %"struct.ap_uint<32>"* %37)
  call void @copy_in(%"class.hls::stream<ap_uint<16>, 0>"* null, %"class.hls::stream<ap_uint<16>, 0>"* %0, %"struct.ssdm_int<1, false>"* null, %"struct.ssdm_int<1, false>"* %1, %"class.hls::stream<appNotification, 0>"* %38, i88* %2, %"class.hls::stream<appTxMeta, 0>"* %39, i32* %3, %"class.hls::stream<ap_uint<16>, 0>"* null, %"class.hls::stream<ap_uint<16>, 0>"* %4, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* %40, i512* %5, i64* %6, i64* %7, i1* %8, %"class.hls::stream<ipTuple, 0>"* %41, i48* %9, %"class.hls::stream<openStatus, 0>"* %42, i72* %10, %"class.hls::stream<ap_uint<16>, 0>"* null, %"class.hls::stream<ap_uint<16>, 0>"* %11, %"class.hls::stream<appTxMeta, 0>"* %43, i32* %12, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"* %44, i512* %13, i64* %14, i64* %15, i1* %16, %"class.hls::stream<appTxRsp, 0>"* %45, i64* %17)
  ret void
}

declare void @scatter_hw_stub(%"class.hls::stream<ap_uint<16>, 0>"*, %"struct.ssdm_int<1, false>"*, %"class.hls::stream<appNotification, 0>"*, %"class.hls::stream<appTxMeta, 0>"*, %"class.hls::stream<ap_uint<16>, 0>"*, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"*, %"class.hls::stream<ipTuple, 0>"*, %"class.hls::stream<openStatus, 0>"*, %"class.hls::stream<ap_uint<16>, 0>"*, %"class.hls::stream<appTxMeta, 0>"*, %"class.hls::stream<hls::axis<ap_uint<512>, 0, 0, 0>, 0>"*, %"class.hls::stream<appTxRsp, 0>"*, %"struct.ap_uint<1>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<16>"*, %"struct.ap_uint<1>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<32>"*)
