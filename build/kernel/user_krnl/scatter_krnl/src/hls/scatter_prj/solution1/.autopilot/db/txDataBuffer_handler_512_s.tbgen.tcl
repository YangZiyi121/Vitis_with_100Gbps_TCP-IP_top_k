set moduleName txDataBuffer_handler_512_s
set isTopModule 0
...
set C_modelName {txDataBuffer_handler<512>}
...
set C_modelArgList {
	...
	{ txDataBuffer int 1024 regular {fifo 0 volatile } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "m_axis_tx_data_V_data_V", "interface" : "axis", "bitwidth" : 512, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "txDataBuffer", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ txDataBuffer_dout sc_in sc_lv 1024 signal 4 } 
	{ txDataBuffer_empty_n sc_in sc_logic 1 signal 4 } 
	{ txDataBuffer_read sc_out sc_logic 1 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "txDataBuffer_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "txDataBuffer", "role": "dout" }} , 
 	{ "name": "txDataBuffer_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "txDataBuffer", "role": "empty_n" }} , 
 	{ "name": "txDataBuffer_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "txDataBuffer", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"Port" : [
			...
			{"Name" : "txDataBuffer", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "512", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_tx_data_V_strb_V_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_tx_data_V_last_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	txDataBuffer { ap_fifo {  { txDataBuffer_dout fifo_data 0 1024 }  { txDataBuffer_empty_n fifo_status 0 1 }  { txDataBuffer_read fifo_update 1 1 } } }
}
