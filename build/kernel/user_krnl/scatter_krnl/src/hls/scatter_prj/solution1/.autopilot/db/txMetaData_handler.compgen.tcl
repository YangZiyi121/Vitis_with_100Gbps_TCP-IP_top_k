...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_tx_metadata_TREADY { I 1 bit } m_axis_tx_metadata_TDATA { O 32 vector } m_axis_tx_metadata_TVALID { O 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { txMetaDataBuffer_dout { I 32 vector } txMetaDataBuffer_empty_n { I 1 bit } txMetaDataBuffer_read { O 1 bit } } \
} "
}
