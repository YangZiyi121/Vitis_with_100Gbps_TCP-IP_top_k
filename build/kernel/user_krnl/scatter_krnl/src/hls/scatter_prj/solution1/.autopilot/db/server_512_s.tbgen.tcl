...
set C_modelArgMapList {[ 
	{ "Name" : "m_axis_listen_port", "interface" : "axis", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "usePort", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ usePort_dout sc_in sc_lv 16 signal 6 } 
	{ usePort_empty_n sc_in sc_logic 1 signal 6 } 
	{ usePort_read sc_out sc_logic 1 signal 6 } 
	{ regBasePort_dout sc_in sc_lv 16 signal 7 } 
	{ regBasePort_empty_n sc_in sc_logic 1 signal 7 } 
	{ regBasePort_read sc_out sc_logic 1 signal 7 } 
	{ runExperiment_dout sc_in sc_lv 1 signal 5 } 
	{ runExperiment_empty_n sc_in sc_logic 1 signal 5 } 
	{ runExperiment_read sc_out sc_logic 1 signal 5 } 
	...
	{ rxDataBuffer_dout sc_in sc_lv 1024 signal 8 } 
	{ rxDataBuffer_empty_n sc_in sc_logic 1 signal 8 } 
	{ rxDataBuffer_read sc_out sc_logic 1 signal 8 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "usePort_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "usePort", "role": "dout" }} , 
 	{ "name": "usePort_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "usePort", "role": "empty_n" }} , 
 	{ "name": "usePort_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "usePort", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"Port" : [
			...
			{"Name" : "usePort", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	usePort { ap_fifo {  { usePort_dout fifo_data 0 16 }  { usePort_empty_n fifo_status 0 1 }  { usePort_read fifo_update 1 1 } } }
