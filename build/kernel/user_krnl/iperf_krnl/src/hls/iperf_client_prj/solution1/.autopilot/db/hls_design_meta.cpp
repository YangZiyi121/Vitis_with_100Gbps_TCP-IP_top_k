...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("dualModeEn", 1, hls_in, 19, "ap_none", "in_data", 1),
	Port_Property("useConn", 14, hls_in, 20, "ap_none", "in_data", 1),
	Port_Property("pkgWordCount", 8, hls_in, 21, "ap_none", "in_data", 1),
	Port_Property("packetGap", 8, hls_in, 22, "ap_none", "in_data", 1),
	Port_Property("timeInSeconds", 32, hls_in, 23, "ap_none", "in_data", 1),
	Port_Property("timeInCycles", 64, hls_in, 24, "ap_none", "in_data", 1),
	Port_Property("useIpAddr", 16, hls_in, 25, "ap_none", "in_data", 1),
	Port_Property("regBasePort", 16, hls_in, 26, "ap_none", "in_data", 1),
...
const char* HLS_Design_Meta::dut_name = "iperf_client";
