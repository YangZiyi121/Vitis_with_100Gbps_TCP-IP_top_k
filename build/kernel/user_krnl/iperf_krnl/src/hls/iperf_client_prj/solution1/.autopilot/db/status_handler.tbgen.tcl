...
set C_modelArgList {
	...
	{ txStatusBuffer int 32 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_tx_status", "interface" : "axis", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "txStatusBuffer", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ txStatusBuffer_din sc_out sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "txStatusBuffer_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "txStatusBuffer", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	txStatusBuffer { ap_fifo {  { txStatusBuffer_din fifo_data 1 32 }  { txStatusBuffer_full_n fifo_status 0 1 }  { txStatusBuffer_write fifo_update 1 1 } } }
}
