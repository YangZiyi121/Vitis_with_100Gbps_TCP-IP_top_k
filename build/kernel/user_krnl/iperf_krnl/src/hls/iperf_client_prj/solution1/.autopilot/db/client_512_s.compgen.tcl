...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { dualModeEn_dout { I 1 vector } dualModeEn_empty_n { I 1 bit } dualModeEn_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_useConn \
    op interface \
    ports { useConn_dout { I 14 vector } useConn_empty_n { I 1 bit } useConn_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { pkgWordCount_dout { I 8 vector } pkgWordCount_empty_n { I 1 bit } pkgWordCount_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { packetGap_dout { I 8 vector } packetGap_empty_n { I 1 bit } packetGap_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { timeInSeconds_dout { I 32 vector } timeInSeconds_empty_n { I 1 bit } timeInSeconds_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { startSignalFifo_din { O 1 vector } startSignalFifo_full_n { I 1 bit } startSignalFifo_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { txStatusBuffer_dout { I 32 vector } txStatusBuffer_empty_n { I 1 bit } txStatusBuffer_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stopSignalFifo_dout { I 1 vector } stopSignalFifo_empty_n { I 1 bit } stopSignalFifo_read { O 1 bit } } \
} "
}
