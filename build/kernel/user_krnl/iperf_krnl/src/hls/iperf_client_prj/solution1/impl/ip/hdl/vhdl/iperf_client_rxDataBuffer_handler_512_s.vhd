...
entity iperf_client_rxDataBuffer_handler_512_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of iperf_client_rxDataBuffer_handler_512_s is 
...
begin
    regslice_both_s_axis_rx_data_V_data_V_U : component iperf_client_regslice_both
    generic map (
        DataWidth => 512)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_rx_data_V_keep_V_U : component iperf_client_regslice_both
    generic map (
        DataWidth => 64)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_rx_data_V_strb_V_U : component iperf_client_regslice_both
    generic map (
        DataWidth => 64)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_rx_data_V_last_V_U : component iperf_client_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_34_p6, ap_done_reg, rxDataBuffer_full_n, tmp_reg_91, s_axis_rx_data_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_done_reg = ap_const_logic_1) or ((tmp_reg_91 = ap_const_lv1_1) and (rxDataBuffer_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((tmp_nbreadreq_fu_34_p6 = ap_const_lv1_1) and (s_axis_rx_data_TVALID_int_regslice = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_34_p6, ap_done_reg, rxDataBuffer_full_n, tmp_reg_91, s_axis_rx_data_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_done_reg = ap_const_logic_1) or ((tmp_reg_91 = ap_const_lv1_1) and (rxDataBuffer_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((tmp_nbreadreq_fu_34_p6 = ap_const_lv1_1) and (s_axis_rx_data_TVALID_int_regslice = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_34_p6, ap_done_reg, rxDataBuffer_full_n, tmp_reg_91, s_axis_rx_data_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_done_reg = ap_const_logic_1) or ((tmp_reg_91 = ap_const_lv1_1) and (rxDataBuffer_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((tmp_nbreadreq_fu_34_p6 = ap_const_lv1_1) and (s_axis_rx_data_TVALID_int_regslice = ap_const_logic_0)))));
    end process;


    ap_block_state1_pp0_stage0_iter0_assign_proc : process(tmp_nbreadreq_fu_34_p6, ap_done_reg, s_axis_rx_data_TVALID_int_regslice)
    begin
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(rxDataBuffer_full_n, tmp_reg_91)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((tmp_reg_91 = ap_const_lv1_1) and (rxDataBuffer_full_n = ap_const_logic_0));
    end process;
    ...
    rxDataBuffer_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, rxDataBuffer_full_n, tmp_reg_91, ap_block_pp0_stage0)
    begin
    ...
    rxDataBuffer_din <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_12_i_fu_79_p4),1024));

    rxDataBuffer_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_reg_91, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_reg_91 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            rxDataBuffer_write <= ap_const_logic_1;
        else 
            rxDataBuffer_write <= ap_const_logic_0;
        end if; 
    end process;


    s_axis_rx_data_TDATA_blk_n_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, tmp_nbreadreq_fu_34_p6, ap_done_reg, ap_block_pp0_stage0, s_axis_rx_data_TVALID_int_regslice)
    begin
