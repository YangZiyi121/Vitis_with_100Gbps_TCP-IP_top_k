set moduleName rxDataBuffer_handler_512_s
set isTopModule 0
...
set C_modelName {rxDataBuffer_handler<512>}
...
set C_modelArgList {
	...
	{ rxDataBuffer int 1024 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_rx_data_V_data_V", "interface" : "axis", "bitwidth" : 512, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "rxDataBuffer", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ rxDataBuffer_din sc_out sc_lv 1024 signal 4 } 
	{ rxDataBuffer_full_n sc_in sc_logic 1 signal 4 } 
	{ rxDataBuffer_write sc_out sc_logic 1 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rxDataBuffer_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "rxDataBuffer", "role": "din" }} , 
 	{ "name": "rxDataBuffer_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rxDataBuffer", "role": "full_n" }} , 
 	{ "name": "rxDataBuffer_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rxDataBuffer", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"Port" : [
			...
			{"Name" : "rxDataBuffer", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "512", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "rxDataBuffer_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_rx_data_V_data_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_rx_data_V_keep_V_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_rx_data_V_strb_V_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_rx_data_V_last_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	rxDataBuffer { ap_fifo {  { rxDataBuffer_din fifo_data 1 1024 }  { rxDataBuffer_full_n fifo_status 0 1 }  { rxDataBuffer_write fifo_update 1 1 } } }
}
