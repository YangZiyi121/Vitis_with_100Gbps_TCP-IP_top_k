...
module dhcp_client_hls_deadlock_idx0_monitor ( // for module dhcp_client_dhcp_client_inst
    input wire clock,
    input wire reset,
...
assign process_axis_block_vec[4] = idx3_block & (1'b0 | axis_block_sigs[4] | axis_block_sigs[5] | axis_block_sigs[6]);
...
// instant sub module
 dhcp_client_hls_deadlock_idx1_monitor dhcp_client_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
 ...
 dhcp_client_hls_deadlock_idx2_monitor dhcp_client_hls_deadlock_idx2_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
 ...
 dhcp_client_hls_deadlock_idx3_monitor dhcp_client_hls_deadlock_idx3_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
