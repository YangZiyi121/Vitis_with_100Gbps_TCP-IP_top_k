    ...
    function [376:0] proc_path(input [PROC_NUM - 1:0] dl_vec);
        ...
        begin
            ...
            case (index)
                0 : begin
                    proc_path = "dhcp_client_dhcp_client.entry_proc_U0";
                end
                1 : begin
        ...
        begin
            ...
            case (index1)
                0 : begin
                    case(index2)
                    3: begin
                        if (~entry_proc_U0.dhcpEnable_c_blk_n) begin
                        ...
                        if (~entry_proc_U0.inputIpAddress_c_blk_n) begin
                ...
                2 : begin
                    case(index2)
                    4: begin
                        if (~receive_message_U0.myMacAddress_c_blk_n) begin
                            if (~myMacAddress_c_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'dhcp_client_dhcp_client.myMacAddress_c_U' written by process 'dhcp_client_dhcp_client.send_message_U0'");
                                $fdisplay(fp, "Dependence_Channel_path dhcp_client_dhcp_client.myMacAddress_c_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~myMacAddress_c_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'dhcp_client_dhcp_client.myMacAddress_c_U' read by process 'dhcp_client_dhcp_client.send_message_U0'");
                                $fdisplay(fp, "Dependence_Channel_path dhcp_client_dhcp_client.myMacAddress_c_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                ...
                3 : begin
                    ...
                    0: begin
                        if (~dhcp_fsm_U0.dhcpEnable_blk_n) begin
                            if (~dhcpEnable_c_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'dhcp_client_dhcp_client.dhcpEnable_c_U' written by process 'dhcp_client_dhcp_client.entry_proc_U0'");
                                $fdisplay(fp, "Dependence_Channel_path dhcp_client_dhcp_client.dhcpEnable_c_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~dhcpEnable_c_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'dhcp_client_dhcp_client.dhcpEnable_c_U' read by process 'dhcp_client_dhcp_client.entry_proc_U0'");
                                $fdisplay(fp, "Dependence_Channel_path dhcp_client_dhcp_client.dhcpEnable_c_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                        if (~dhcp_fsm_U0.inputIpAddress_blk_n) begin
                            if (~inputIpAddress_c_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'dhcp_client_dhcp_client.inputIpAddress_c_U' written by process 'dhcp_client_dhcp_client.entry_proc_U0'");
                                $fdisplay(fp, "Dependence_Channel_path dhcp_client_dhcp_client.inputIpAddress_c_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~inputIpAddress_c_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'dhcp_client_dhcp_client.inputIpAddress_c_U' read by process 'dhcp_client_dhcp_client.entry_proc_U0'");
                                $fdisplay(fp, "Dependence_Channel_path dhcp_client_dhcp_client.inputIpAddress_c_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
