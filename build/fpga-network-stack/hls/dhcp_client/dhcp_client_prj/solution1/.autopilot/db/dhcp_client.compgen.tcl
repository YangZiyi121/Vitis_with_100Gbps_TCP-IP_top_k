...
# FIFO definition: 
set ID 46
set FifoName dhcp_client_fifo_w48_d3_S
...
# FIFO definition: 
set ID 47
set FifoName dhcp_client_fifo_w104_d4_S
...
# FIFO definition: 
set ID 48
set FifoName dhcp_client_fifo_w72_d4_S
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_open_port_TDATA { O 16 vector } m_axis_open_port_TVALID { O 1 bit } m_axis_open_port_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_open_port_status_TDATA { I 8 vector } s_axis_open_port_status_TVALID { I 1 bit } s_axis_open_port_status_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_rx_metadata_TDATA { I 128 vector } s_axis_rx_metadata_TVALID { I 1 bit } s_axis_rx_metadata_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_tx_metadata_TDATA { O 96 vector } m_axis_tx_metadata_TVALID { O 1 bit } m_axis_tx_metadata_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 57 \
    name m_axis_tx_length \
    reset_level 0 \
    sync_rst true \
    corename {} \
    metadata {  } \
    op interface \
    ports { m_axis_tx_length_TDATA { O 16 vector } m_axis_tx_length_TVALID { O 1 bit } m_axis_tx_length_TREADY { I 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'm_axis_tx_length'"
}
}
