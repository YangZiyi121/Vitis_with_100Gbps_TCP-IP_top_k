...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_tx_metadata_TREADY { I 1 bit } m_axis_tx_metadata_TDATA { O 96 vector } m_axis_tx_metadata_TVALID { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_tx_length_TREADY { I 1 bit } m_axis_tx_length_TDATA { O 16 vector } m_axis_tx_length_TVALID { O 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { dhcp_requestMetaFifo_dout { I 72 vector } dhcp_requestMetaFifo_empty_n { I 1 bit } dhcp_requestMetaFifo_read { O 1 bit } } \
} "
}
