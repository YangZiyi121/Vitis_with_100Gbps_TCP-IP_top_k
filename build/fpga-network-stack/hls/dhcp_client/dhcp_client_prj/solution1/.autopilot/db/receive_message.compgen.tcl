...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_rx_metadata_TVALID { I 1 bit } s_axis_rx_metadata_TDATA { I 128 vector } s_axis_rx_metadata_TREADY { O 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { dhcp_replyMetaFifo_din { O 104 vector } dhcp_replyMetaFifo_full_n { I 1 bit } dhcp_replyMetaFifo_write { O 1 bit } } \
} "
}
