...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { dhcp_requestMetaFifo_din { O 72 vector } dhcp_requestMetaFifo_full_n { I 1 bit } dhcp_requestMetaFifo_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { dhcp_replyMetaFifo_dout { I 104 vector } dhcp_replyMetaFifo_empty_n { I 1 bit } dhcp_replyMetaFifo_read { O 1 bit } } \
} "
}
