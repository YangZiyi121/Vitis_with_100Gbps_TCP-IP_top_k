...
// wrapc file define:
#define AUTOTB_TVIN_s_axis_rx_meta "../tv/cdatafile/c.udp_top.autotvin_s_axis_rx_meta.dat"
#define AUTOTB_TVOUT_s_axis_rx_meta "../tv/cdatafile/c.udp_top.autotvout_s_axis_rx_meta.dat"
#define WRAPC_STREAM_SIZE_IN_s_axis_rx_meta "../tv/stream_size/stream_size_in_s_axis_rx_meta.dat"
#define WRAPC_STREAM_INGRESS_STATUS_s_axis_rx_meta "../tv/stream_size/stream_ingress_status_s_axis_rx_meta.dat"
// wrapc file define:
...
// wrapc file define:
#define AUTOTB_TVIN_m_axis_rx_meta "../tv/cdatafile/c.udp_top.autotvin_m_axis_rx_meta.dat"
#define AUTOTB_TVOUT_m_axis_rx_meta "../tv/cdatafile/c.udp_top.autotvout_m_axis_rx_meta.dat"
#define WRAPC_STREAM_SIZE_OUT_m_axis_rx_meta "../tv/stream_size/stream_size_out_m_axis_rx_meta.dat"
#define WRAPC_STREAM_EGRESS_STATUS_m_axis_rx_meta "../tv/stream_size/stream_egress_status_m_axis_rx_meta.dat"
// wrapc file define:
...
// wrapc file define:
#define AUTOTB_TVIN_s_axis_tx_meta "../tv/cdatafile/c.udp_top.autotvin_s_axis_tx_meta.dat"
#define AUTOTB_TVOUT_s_axis_tx_meta "../tv/cdatafile/c.udp_top.autotvout_s_axis_tx_meta.dat"
...
// wrapc file define:
#define AUTOTB_TVIN_m_axis_tx_meta "../tv/cdatafile/c.udp_top.autotvin_m_axis_tx_meta.dat"
#define AUTOTB_TVOUT_m_axis_tx_meta "../tv/cdatafile/c.udp_top.autotvout_m_axis_tx_meta.dat"
#define WRAPC_STREAM_SIZE_OUT_m_axis_tx_meta "../tv/stream_size/stream_size_out_m_axis_tx_meta.dat"
#define WRAPC_STREAM_EGRESS_STATUS_m_axis_tx_meta "../tv/stream_size/stream_egress_status_m_axis_tx_meta.dat"
// wrapc file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_s_axis_rx_meta "../tv/rtldatafile/rtl.udp_top.autotvout_s_axis_rx_meta.dat"
// tvout file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_m_axis_rx_meta "../tv/rtldatafile/rtl.udp_top.autotvout_m_axis_rx_meta.dat"
// tvout file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_s_axis_tx_meta "../tv/rtldatafile/rtl.udp_top.autotvout_s_axis_tx_meta.dat"
// tvout file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_m_axis_tx_meta "../tv/rtldatafile/rtl.udp_top.autotvout_m_axis_tx_meta.dat"
// tvout file define:
...
string get_depth_list () {
  ...
  total_list << "{s_axis_rx_meta " << s_axis_rx_meta_depth << "}\n";
  ...
  total_list << "{m_axis_rx_meta " << m_axis_rx_meta_depth << "}\n";
  ...
  total_list << "{m_axis_tx_meta " << m_axis_tx_meta_depth << "}\n";
...
struct __cosim_s16__ { char data[32]; };
extern "C" void udp_top_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, __cosim_s10__*, __cosim_s2__*);
...
static AESL_FILE_HANDLER aesl_fh;
  ...
  if (wrapc_switch_file_token.good())
  {
    ...
    string AESL_token;
    string AESL_num;
long __xlx_apatb_param_s_axis_rx_meta_stream_buf_final_size;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
        rtl_tv_out_file.open(WRAPC_STREAM_SIZE_IN_s_axis_rx_meta);
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          while (AESL_token != "[[/transaction]]"){__xlx_apatb_param_s_axis_rx_meta_stream_buf_final_size = atoi(AESL_token.c_str());
  ...
  for (long i = 0; i < __xlx_apatb_param_s_axis_rx_meta_stream_buf_final_size; ++i)((hls::stream<long long>*)__xlx_apatb_param_s_axis_rx_meta)->read();
...
long __xlx_apatb_param_m_axis_rx_meta_stream_buf_final_size;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
        rtl_tv_out_file.open(WRAPC_STREAM_SIZE_OUT_m_axis_rx_meta);
        if (rtl_tv_out_file.good()) {
          rtl_tv_out_file >> AESL_token;
          if (AESL_token != "[[[runtime]]]")
            exit(1);
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){__xlx_apatb_param_m_axis_rx_meta_stream_buf_final_size = atoi(AESL_token.c_str());
    ...
    } // end post check logic bolck
  {
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
        rtl_tv_out_file.open(AUTOTB_TVOUT_PC_m_axis_rx_meta);
        if (rtl_tv_out_file.good()) {
          rtl_tv_out_file >> AESL_token;
          if (AESL_token != "[[[runtime]]]")
            exit(1);
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<176> > m_axis_rx_meta_pc_buffer;
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){

            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "m_axis_rx_meta");
  
            // push token into output port buffer
            if (AESL_token != "") {
              m_axis_rx_meta_pc_buffer.push_back(AESL_token.c_str());
              i++;
            }
          ...
          if (has_unknown_value) {
            cerr << "WARNING: [SIM 212-201] RTL produces unknown value 'x' or 'X' on port " 
                 << "m_axis_rx_meta" << ", possible cause: There are uninitialized variables in the C design."
                 << endl; 
          }
  
          if (i > 0) {for (int j = 0, e = i; j != e; ++j) {
__cosim_s20__ xlx_stream_elt;
((long long*)&xlx_stream_elt)[0*4+0] = m_axis_rx_meta_pc_buffer[j].range(63,0).to_int64();
((long long*)&xlx_stream_elt)[0*4+1] = m_axis_rx_meta_pc_buffer[j].range(127,64).to_int64();
((long long*)&xlx_stream_elt)[0*4+2] = m_axis_rx_meta_pc_buffer[j].range(175,128).to_int64();
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          while (AESL_token != "[[/transaction]]"){
            ...
            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "m_axis_rx_data");
          ...
          if (has_unknown_value) {
            cerr << "WARNING: [SIM 212-201] RTL produces unknown value 'x' or 'X' on port " 
                 << "m_axis_rx_data" << ", possible cause: There are uninitialized variables in the C design."
                 << endl; 
          }
...
((long long*)&xlx_stream_elt_data)[0*8+0] = m_axis_rx_data_V_data_V_pc_buffer_Copy[j].range(63,0).to_int64();
((long long*)&xlx_stream_elt_data)[0*8+1] = m_axis_rx_data_V_data_V_pc_buffer_Copy[j].range(127,64).to_int64();
((long long*)&xlx_stream_elt_data)[0*8+2] = m_axis_rx_data_V_data_V_pc_buffer_Copy[j].range(191,128).to_int64();
((long long*)&xlx_stream_elt_data)[0*8+3] = m_axis_rx_data_V_data_V_pc_buffer_Copy[j].range(255,192).to_int64();
((long long*)&xlx_stream_elt_data)[0*8+4] = m_axis_rx_data_V_data_V_pc_buffer_Copy[j].range(319,256).to_int64();
((long long*)&xlx_stream_elt_data)[0*8+5] = m_axis_rx_data_V_data_V_pc_buffer_Copy[j].range(383,320).to_int64();
((long long*)&xlx_stream_elt_data)[0*8+6] = m_axis_rx_data_V_data_V_pc_buffer_Copy[j].range(447,384).to_int64();
((long long*)&xlx_stream_elt_data)[0*8+7] = m_axis_rx_data_V_data_V_pc_buffer_Copy[j].range(511,448).to_int64();
((hls::stream<__cosim_s40__>*)__xlx_apatb_param_m_axis_rx_data_V_data_V)->write(xlx_stream_elt_data);
long long xlx_stream_elt_keep;
((long long*)&xlx_stream_elt_keep)[0] = m_axis_rx_data_V_keep_V_pc_buffer_Copy[j].to_int64();
((hls::stream<long long>*)__xlx_apatb_param_m_axis_rx_data_V_keep_V)->write(xlx_stream_elt_keep);
long long xlx_stream_elt_strb;
((long long*)&xlx_stream_elt_strb)[0] = m_axis_rx_data_V_strb_V_pc_buffer_Copy[j].to_int64();
((hls::stream<long long>*)__xlx_apatb_param_m_axis_rx_data_V_strb_V)->write(xlx_stream_elt_strb);
char xlx_stream_elt_last;
((char*)&xlx_stream_elt_last)[0] = m_axis_rx_data_V_last_V_pc_buffer_Copy[j].to_uint64();
((hls::stream<char>*)__xlx_apatb_param_m_axis_rx_data_V_last_V)->write(xlx_stream_elt_last);
}}long __xlx_apatb_param_s_axis_tx_meta_stream_buf_final_size;
{
  ...
  for (long i = 0; i < __xlx_apatb_param_s_axis_tx_meta_stream_buf_final_size; ++i)((hls::stream<__cosim_s20__>*)__xlx_apatb_param_s_axis_tx_meta)->read();
long __xlx_apatb_param_s_axis_tx_data_stream_buf_final_size;
{
  ...
  for (long i = 0; i < __xlx_apatb_param_s_axis_tx_data_stream_buf_final_size; ++i) {
((hls::stream<__cosim_s40__>*)__xlx_apatb_param_s_axis_tx_data_V_data_V)->read();
((hls::stream<long long>*)__xlx_apatb_param_s_axis_tx_data_V_keep_V)->read();
((hls::stream<long long>*)__xlx_apatb_param_s_axis_tx_data_V_strb_V)->read();
((hls::stream<char>*)__xlx_apatb_param_s_axis_tx_data_V_last_V)->read();
}
long __xlx_apatb_param_m_axis_tx_meta_stream_buf_final_size;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
        rtl_tv_out_file.open(WRAPC_STREAM_SIZE_OUT_m_axis_tx_meta);
        if (rtl_tv_out_file.good()) {
          rtl_tv_out_file >> AESL_token;
          if (AESL_token != "[[[runtime]]]")
            exit(1);
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){__xlx_apatb_param_m_axis_tx_meta_stream_buf_final_size = atoi(AESL_token.c_str());
    ...
    } // end post check logic bolck
  {
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
        rtl_tv_out_file.open(AUTOTB_TVOUT_PC_m_axis_tx_meta);
        if (rtl_tv_out_file.good()) {
          rtl_tv_out_file >> AESL_token;
          if (AESL_token != "[[[runtime]]]")
            exit(1);
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<48> > m_axis_tx_meta_pc_buffer;
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){

            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "m_axis_tx_meta");
  
            // push token into output port buffer
            if (AESL_token != "") {
              m_axis_tx_meta_pc_buffer.push_back(AESL_token.c_str());
              i++;
            }
          ...
          if (has_unknown_value) {
            cerr << "WARNING: [SIM 212-201] RTL produces unknown value 'x' or 'X' on port " 
                 << "m_axis_tx_meta" << ", possible cause: There are uninitialized variables in the C design."
                 << endl; 
          }
  
          if (i > 0) {for (int j = 0, e = i; j != e; ++j) {
long long xlx_stream_elt;
((char*)&xlx_stream_elt)[0*8+0] = m_axis_tx_meta_pc_buffer[j].range(7, 0).to_int64();
((char*)&xlx_stream_elt)[0*8+1] = m_axis_tx_meta_pc_buffer[j].range(15, 8).to_int64();
((char*)&xlx_stream_elt)[0*8+2] = m_axis_tx_meta_pc_buffer[j].range(23, 16).to_int64();
((char*)&xlx_stream_elt)[0*8+3] = m_axis_tx_meta_pc_buffer[j].range(31, 24).to_int64();
((char*)&xlx_stream_elt)[0*8+4] = m_axis_tx_meta_pc_buffer[j].range(39, 32).to_int64();
((char*)&xlx_stream_elt)[0*8+5] = m_axis_tx_meta_pc_buffer[j].range(47, 40).to_int64();
((hls::stream<long long>*)__xlx_apatb_param_m_axis_tx_meta)->write(xlx_stream_elt);
}
}
        } // end transaction
      } // end file is good
...
aesl_fh.touch(WRAPC_STREAM_SIZE_IN_s_axis_rx_meta);
aesl_fh.touch(WRAPC_STREAM_INGRESS_STATUS_s_axis_rx_meta);
...
aesl_fh.touch(WRAPC_STREAM_SIZE_OUT_m_axis_rx_meta);
aesl_fh.touch(WRAPC_STREAM_EGRESS_STATUS_m_axis_rx_meta);
...
aesl_fh.touch(WRAPC_STREAM_SIZE_OUT_m_axis_tx_meta);
aesl_fh.touch(WRAPC_STREAM_EGRESS_STATUS_m_axis_tx_meta);
...
std::vector<long long> __xlx_apatb_param_s_axis_rx_meta_stream_buf;
{
  while (!((hls::stream<long long>*)__xlx_apatb_param_s_axis_rx_meta)->empty())
    __xlx_apatb_param_s_axis_rx_meta_stream_buf.push_back(((hls::stream<long long>*)__xlx_apatb_param_s_axis_rx_meta)->read());
  for (int i = 0; i < __xlx_apatb_param_s_axis_rx_meta_stream_buf.size(); ++i)
    ((hls::stream<long long>*)__xlx_apatb_param_s_axis_rx_meta)->write(__xlx_apatb_param_s_axis_rx_meta_stream_buf[i]);
  }
long __xlx_apatb_param_s_axis_rx_meta_stream_buf_size = ((hls::stream<long long>*)__xlx_apatb_param_s_axis_rx_meta)->size();
// data
...
// data
std::vector<__cosim_s40__> __xlx_apatb_param_m_axis_rx_data_V_data_V_stream_buf;
long __xlx_apatb_param_m_axis_rx_data_stream_buf_size = ((hls::stream<__cosim_s40__>*)__xlx_apatb_param_m_axis_rx_data_V_data_V)->size();
// keep
std::vector<long long> __xlx_apatb_param_m_axis_rx_data_V_keep_V_stream_buf;
// strb
std::vector<long long> __xlx_apatb_param_m_axis_rx_data_V_strb_V_stream_buf;
// user
// last
std::vector<char> __xlx_apatb_param_m_axis_rx_data_V_last_V_stream_buf;
// id
// dest
...
// data
std::vector<__cosim_s40__> __xlx_apatb_param_s_axis_tx_data_V_data_V_stream_buf;
{
  while (!((hls::stream<__cosim_s40__>*)__xlx_apatb_param_s_axis_tx_data_V_data_V)->empty())
    __xlx_apatb_param_s_axis_tx_data_V_data_V_stream_buf.push_back(((hls::stream<__cosim_s40__>*)__xlx_apatb_param_s_axis_tx_data_V_data_V)->read());
  for (int i = 0; i < __xlx_apatb_param_s_axis_tx_data_V_data_V_stream_buf.size(); ++i)
    ((hls::stream<__cosim_s40__>*)__xlx_apatb_param_s_axis_tx_data_V_data_V)->write(__xlx_apatb_param_s_axis_tx_data_V_data_V_stream_buf[i]);
  }
long __xlx_apatb_param_s_axis_tx_data_stream_buf_size = ((hls::stream<__cosim_s40__>*)__xlx_apatb_param_s_axis_tx_data_V_data_V)->size();
// keep
std::vector<long long> __xlx_apatb_param_s_axis_tx_data_V_keep_V_stream_buf;
{
  while (!((hls::stream<long long>*)__xlx_apatb_param_s_axis_tx_data_V_keep_V)->empty())
    __xlx_apatb_param_s_axis_tx_data_V_keep_V_stream_buf.push_back(((hls::stream<long long>*)__xlx_apatb_param_s_axis_tx_data_V_keep_V)->read());
  for (int i = 0; i < __xlx_apatb_param_s_axis_tx_data_V_keep_V_stream_buf.size(); ++i)
    ((hls::stream<long long>*)__xlx_apatb_param_s_axis_tx_data_V_keep_V)->write(__xlx_apatb_param_s_axis_tx_data_V_keep_V_stream_buf[i]);
  }
// strb
std::vector<long long> __xlx_apatb_param_s_axis_tx_data_V_strb_V_stream_buf;
{
  while (!((hls::stream<long long>*)__xlx_apatb_param_s_axis_tx_data_V_strb_V)->empty())
    __xlx_apatb_param_s_axis_tx_data_V_strb_V_stream_buf.push_back(((hls::stream<long long>*)__xlx_apatb_param_s_axis_tx_data_V_strb_V)->read());
  for (int i = 0; i < __xlx_apatb_param_s_axis_tx_data_V_strb_V_stream_buf.size(); ++i)
    ((hls::stream<long long>*)__xlx_apatb_param_s_axis_tx_data_V_strb_V)->write(__xlx_apatb_param_s_axis_tx_data_V_strb_V_stream_buf[i]);
  }
// user
// last
std::vector<char> __xlx_apatb_param_s_axis_tx_data_V_last_V_stream_buf;
{
  while (!((hls::stream<char>*)__xlx_apatb_param_s_axis_tx_data_V_last_V)->empty())
    __xlx_apatb_param_s_axis_tx_data_V_last_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_s_axis_tx_data_V_last_V)->read());
  for (int i = 0; i < __xlx_apatb_param_s_axis_tx_data_V_last_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_s_axis_tx_data_V_last_V)->write(__xlx_apatb_param_s_axis_tx_data_V_last_V_stream_buf[i]);
  }
// id
// dest
std::vector<long long> __xlx_apatb_param_m_axis_tx_meta_stream_buf;
long __xlx_apatb_param_m_axis_tx_meta_stream_buf_size = ((hls::stream<long long>*)__xlx_apatb_param_m_axis_tx_meta)->size();
// data
...
{
aesl_fh.write(AUTOTB_TVIN_reg_ip_address, begin_str(AESL_transaction));
{
...
aesl_fh.write(AUTOTB_TVIN_reg_ip_address, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.reg_ip_address_depth);
aesl_fh.write(AUTOTB_TVIN_reg_ip_address, end_str());
}

// print reg_listen_port Transactions
{
aesl_fh.write(AUTOTB_TVIN_reg_listen_port, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_reg_listen_port);
aesl_fh.write(AUTOTB_TVIN_reg_listen_port, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.reg_listen_port_depth);
aesl_fh.write(AUTOTB_TVIN_reg_listen_port, end_str());
}

CodeState = CALL_C_DUT;
udp_top_hw_stub_wrapper(__xlx_apatb_param_s_axis_rx_meta, __xlx_apatb_param_s_axis_rx_data_V_data_V, __xlx_apatb_param_s_axis_rx_data_V_keep_V, __xlx_apatb_param_s_axis_rx_data_V_strb_V, __xlx_apatb_param_s_axis_rx_data_V_last_V, __xlx_apatb_param_m_axis_rx_meta, __xlx_apatb_param_m_axis_rx_data_V_data_V, __xlx_apatb_param_m_axis_rx_data_V_keep_V, __xlx_apatb_param_m_axis_rx_data_V_strb_V, __xlx_apatb_param_m_axis_rx_data_V_last_V, __xlx_apatb_param_s_axis_tx_meta, __xlx_apatb_param_s_axis_tx_data_V_data_V, __xlx_apatb_param_s_axis_tx_data_V_keep_V, __xlx_apatb_param_s_axis_tx_data_V_strb_V, __xlx_apatb_param_s_axis_tx_data_V_last_V, __xlx_apatb_param_m_axis_tx_meta, __xlx_apatb_param_m_axis_tx_data_V_data_V, __xlx_apatb_param_m_axis_tx_data_V_keep_V, __xlx_apatb_param_m_axis_tx_data_V_strb_V, __xlx_apatb_param_m_axis_tx_data_V_last_V, __xlx_apatb_param_reg_ip_address, __xlx_apatb_param_reg_listen_port);
CodeState = DUMP_OUTPUTS;
long __xlx_apatb_param_s_axis_rx_meta_stream_buf_final_size = __xlx_apatb_param_s_axis_rx_meta_stream_buf_size - ((hls::stream<long long>*)__xlx_apatb_param_s_axis_rx_meta)->size();
// print s_axis_rx_meta Transactions
{
aesl_fh.write(AUTOTB_TVIN_s_axis_rx_meta, begin_str(AESL_transaction));
...
__xlx_tmp_lv_hw = __xlx_tmp_lv;
    ...
    aesl_fh.write(AUTOTB_TVIN_s_axis_rx_meta, __xlx_sprintf_buffer.data()); 
  }

  tcl_file.set_num(__xlx_apatb_param_s_axis_rx_meta_stream_buf_final_size, &tcl_file.s_axis_rx_meta_depth);
aesl_fh.write(AUTOTB_TVIN_s_axis_rx_meta, end_str());
}


// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_s_axis_rx_meta, begin_str(AESL_transaction));
if (__xlx_apatb_param_s_axis_rx_meta_stream_buf_final_size > 0) {
  long s_axis_rx_meta_stream_ingress_size = __xlx_apatb_param_s_axis_rx_meta_stream_buf_size;
sprintf(__xlx_sprintf_buffer.data(), "%d\n", s_axis_rx_meta_stream_ingress_size);
 aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_s_axis_rx_meta, __xlx_sprintf_buffer.data());
  for (int j = 0, e = __xlx_apatb_param_s_axis_rx_meta_stream_buf_final_size; j != e; j++) {
    s_axis_rx_meta_stream_ingress_size--;
sprintf(__xlx_sprintf_buffer.data(), "%d\n", s_axis_rx_meta_stream_ingress_size);
 aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_s_axis_rx_meta, __xlx_sprintf_buffer.data());
  ...
  long s_axis_rx_meta_stream_ingress_size = 0;
sprintf(__xlx_sprintf_buffer.data(), "%d\n", s_axis_rx_meta_stream_ingress_size);
 aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_s_axis_rx_meta, __xlx_sprintf_buffer.data());
}
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_s_axis_rx_meta, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_rx_meta, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_s_axis_rx_meta_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_rx_meta, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_rx_meta, end_str());
}
...
// print m_axis_rx_meta Transactions
{
aesl_fh.write(AUTOTB_TVOUT_m_axis_rx_meta, begin_str(AESL_transaction));
for (int j = 0, e = __xlx_apatb_param_m_axis_rx_meta_stream_buf_final_size; j != e; ++j) {
sc_bv<176> __xlx_tmp_lv;
...
__xlx_tmp_lv.range(175,128) = ((long long*)&__xlx_apatb_param_m_axis_rx_meta_stream_buf[__xlx_apatb_param_m_axis_rx_meta_stream_buf_size+j])[0*4+2];
aesl_fh.write(AUTOTB_TVOUT_m_axis_rx_meta, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}

  tcl_file.set_num(__xlx_apatb_param_m_axis_rx_meta_stream_buf_final_size, &tcl_file.m_axis_rx_meta_depth);
aesl_fh.write(AUTOTB_TVOUT_m_axis_rx_meta, end_str());
}

{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_rx_meta, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_m_axis_rx_meta_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_rx_meta, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_rx_meta, end_str());
}

//********************** dump C output stream *******************
long __xlx_apatb_param_m_axis_rx_data_stream_buf_final_size = ((hls::stream<__cosim_s40__>*)__xlx_apatb_param_m_axis_rx_data_V_data_V)->size() - __xlx_apatb_param_m_axis_rx_data_stream_buf_size;
{
  while (!((hls::stream<__cosim_s40__>*)__xlx_apatb_param_m_axis_rx_data_V_data_V)->empty())
    __xlx_apatb_param_m_axis_rx_data_V_data_V_stream_buf.push_back(((hls::stream<__cosim_s40__>*)__xlx_apatb_param_m_axis_rx_data_V_data_V)->read());
  for (int i = 0; i < __xlx_apatb_param_m_axis_rx_data_V_data_V_stream_buf.size(); ++i)
    ((hls::stream<__cosim_s40__>*)__xlx_apatb_param_m_axis_rx_data_V_data_V)->write(__xlx_apatb_param_m_axis_rx_data_V_data_V_stream_buf[i]);
  }
{
  while (!((hls::stream<long long>*)__xlx_apatb_param_m_axis_rx_data_V_keep_V)->empty())
    __xlx_apatb_param_m_axis_rx_data_V_keep_V_stream_buf.push_back(((hls::stream<long long>*)__xlx_apatb_param_m_axis_rx_data_V_keep_V)->read());
  for (int i = 0; i < __xlx_apatb_param_m_axis_rx_data_V_keep_V_stream_buf.size(); ++i)
    ((hls::stream<long long>*)__xlx_apatb_param_m_axis_rx_data_V_keep_V)->write(__xlx_apatb_param_m_axis_rx_data_V_keep_V_stream_buf[i]);
  }
{
  while (!((hls::stream<long long>*)__xlx_apatb_param_m_axis_rx_data_V_strb_V)->empty())
    __xlx_apatb_param_m_axis_rx_data_V_strb_V_stream_buf.push_back(((hls::stream<long long>*)__xlx_apatb_param_m_axis_rx_data_V_strb_V)->read());
  for (int i = 0; i < __xlx_apatb_param_m_axis_rx_data_V_strb_V_stream_buf.size(); ++i)
    ((hls::stream<long long>*)__xlx_apatb_param_m_axis_rx_data_V_strb_V)->write(__xlx_apatb_param_m_axis_rx_data_V_strb_V_stream_buf[i]);
  }
{
  while (!((hls::stream<char>*)__xlx_apatb_param_m_axis_rx_data_V_last_V)->empty())
    __xlx_apatb_param_m_axis_rx_data_V_last_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_m_axis_rx_data_V_last_V)->read());
  for (int i = 0; i < __xlx_apatb_param_m_axis_rx_data_V_last_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_m_axis_rx_data_V_last_V)->write(__xlx_apatb_param_m_axis_rx_data_V_last_V_stream_buf[i]);
  }
aesl_fh.write(AUTOTB_TVOUT_m_axis_rx_data_V_data_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVOUT_m_axis_rx_data_V_keep_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVOUT_m_axis_rx_data_V_strb_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVOUT_m_axis_rx_data_V_last_V, begin_str(AESL_transaction));
for (int j = 0, e = __xlx_apatb_param_m_axis_rx_data_stream_buf_final_size; j != e; ++j) {
sc_bv<512> __xlx_tmp_0_lv;
{
sc_bv<512> __xlx_tmp_lv;
__xlx_tmp_lv.range(63,0) = ((long long*)&__xlx_apatb_param_m_axis_rx_data_V_data_V_stream_buf[__xlx_apatb_param_m_axis_rx_data_stream_buf_size+j])[0*8+0];
__xlx_tmp_lv.range(127,64) = ((long long*)&__xlx_apatb_param_m_axis_rx_data_V_data_V_stream_buf[__xlx_apatb_param_m_axis_rx_data_stream_buf_size+j])[0*8+1];
__xlx_tmp_lv.range(191,128) = ((long long*)&__xlx_apatb_param_m_axis_rx_data_V_data_V_stream_buf[__xlx_apatb_param_m_axis_rx_data_stream_buf_size+j])[0*8+2];
__xlx_tmp_lv.range(255,192) = ((long long*)&__xlx_apatb_param_m_axis_rx_data_V_data_V_stream_buf[__xlx_apatb_param_m_axis_rx_data_stream_buf_size+j])[0*8+3];
__xlx_tmp_lv.range(319,256) = ((long long*)&__xlx_apatb_param_m_axis_rx_data_V_data_V_stream_buf[__xlx_apatb_param_m_axis_rx_data_stream_buf_size+j])[0*8+4];
__xlx_tmp_lv.range(383,320) = ((long long*)&__xlx_apatb_param_m_axis_rx_data_V_data_V_stream_buf[__xlx_apatb_param_m_axis_rx_data_stream_buf_size+j])[0*8+5];
__xlx_tmp_lv.range(447,384) = ((long long*)&__xlx_apatb_param_m_axis_rx_data_V_data_V_stream_buf[__xlx_apatb_param_m_axis_rx_data_stream_buf_size+j])[0*8+6];
__xlx_tmp_lv.range(511,448) = ((long long*)&__xlx_apatb_param_m_axis_rx_data_V_data_V_stream_buf[__xlx_apatb_param_m_axis_rx_data_stream_buf_size+j])[0*8+7];
__xlx_tmp_0_lv = __xlx_tmp_lv;
}
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_0_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVOUT_m_axis_rx_data_V_data_V, __xlx_sprintf_buffer.data());
sc_bv<64> __xlx_tmp_1_lv = ((long long*)&__xlx_apatb_param_m_axis_rx_data_V_keep_V_stream_buf[__xlx_apatb_param_m_axis_rx_data_stream_buf_size+j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_1_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVOUT_m_axis_rx_data_V_keep_V, __xlx_sprintf_buffer.data());
sc_bv<64> __xlx_tmp_2_lv = ((long long*)&__xlx_apatb_param_m_axis_rx_data_V_strb_V_stream_buf[__xlx_apatb_param_m_axis_rx_data_stream_buf_size+j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_2_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVOUT_m_axis_rx_data_V_strb_V, __xlx_sprintf_buffer.data());
sc_bv<1> __xlx_tmp_4_lv = ((char*)&__xlx_apatb_param_m_axis_rx_data_V_last_V_stream_buf[__xlx_apatb_param_m_axis_rx_data_stream_buf_size+j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_4_lv.to_string(SC_HEX).c_str());
...
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_rx_data_V_data_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_rx_data_V_keep_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_m_axis_rx_data_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_rx_data_V_keep_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_rx_data_V_keep_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_rx_data_V_strb_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_m_axis_rx_data_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_rx_data_V_strb_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_rx_data_V_strb_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_rx_data_V_last_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_m_axis_rx_data_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_rx_data_V_last_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_rx_data_V_last_V, end_str());
}
...
__xlx_tmp_lv_hw = __xlx_tmp_lv;
    ...
    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv_hw.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_s_axis_tx_meta, __xlx_sprintf_buffer.data()); 
  }
...
long __xlx_apatb_param_s_axis_tx_data_stream_buf_final_size = __xlx_apatb_param_s_axis_tx_data_stream_buf_size - ((hls::stream<__cosim_s40__>*)__xlx_apatb_param_s_axis_tx_data_V_data_V)->size();
aesl_fh.write(AUTOTB_TVIN_s_axis_tx_data_V_data_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVIN_s_axis_tx_data_V_keep_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVIN_s_axis_tx_data_V_strb_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVIN_s_axis_tx_data_V_last_V, begin_str(AESL_transaction));
for (int j = 0, e = __xlx_apatb_param_s_axis_tx_data_stream_buf_final_size; j != e; ++j) {
sc_bv<512> __xlx_tmp_0_lv;
{
sc_bv<512> __xlx_tmp_lv;
__xlx_tmp_lv.range(63,0) = ((long long*)&__xlx_apatb_param_s_axis_tx_data_V_data_V_stream_buf[j])[0*8+0];
__xlx_tmp_lv.range(127,64) = ((long long*)&__xlx_apatb_param_s_axis_tx_data_V_data_V_stream_buf[j])[0*8+1];
__xlx_tmp_lv.range(191,128) = ((long long*)&__xlx_apatb_param_s_axis_tx_data_V_data_V_stream_buf[j])[0*8+2];
__xlx_tmp_lv.range(255,192) = ((long long*)&__xlx_apatb_param_s_axis_tx_data_V_data_V_stream_buf[j])[0*8+3];
__xlx_tmp_lv.range(319,256) = ((long long*)&__xlx_apatb_param_s_axis_tx_data_V_data_V_stream_buf[j])[0*8+4];
__xlx_tmp_lv.range(383,320) = ((long long*)&__xlx_apatb_param_s_axis_tx_data_V_data_V_stream_buf[j])[0*8+5];
__xlx_tmp_lv.range(447,384) = ((long long*)&__xlx_apatb_param_s_axis_tx_data_V_data_V_stream_buf[j])[0*8+6];
__xlx_tmp_lv.range(511,448) = ((long long*)&__xlx_apatb_param_s_axis_tx_data_V_data_V_stream_buf[j])[0*8+7];
__xlx_tmp_0_lv = __xlx_tmp_lv;
}
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_0_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVIN_s_axis_tx_data_V_data_V, __xlx_sprintf_buffer.data());
sc_bv<64> __xlx_tmp_1_lv = ((long long*)&__xlx_apatb_param_s_axis_tx_data_V_keep_V_stream_buf[j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_1_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVIN_s_axis_tx_data_V_keep_V, __xlx_sprintf_buffer.data());
sc_bv<64> __xlx_tmp_2_lv = ((long long*)&__xlx_apatb_param_s_axis_tx_data_V_strb_V_stream_buf[j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_2_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVIN_s_axis_tx_data_V_strb_V, __xlx_sprintf_buffer.data());
sc_bv<1> __xlx_tmp_4_lv = ((char*)&__xlx_apatb_param_s_axis_tx_data_V_last_V_stream_buf[j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_4_lv.to_string(SC_HEX).c_str());
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_s_axis_tx_data_V_data_V, end_str());
}

// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_s_axis_tx_data_V_keep_V, begin_str(AESL_transaction));
if (__xlx_apatb_param_s_axis_tx_data_stream_buf_final_size > 0) {
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_s_axis_tx_data_V_keep_V, end_str());
}

// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_s_axis_tx_data_V_strb_V, begin_str(AESL_transaction));
if (__xlx_apatb_param_s_axis_tx_data_stream_buf_final_size > 0) {
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_s_axis_tx_data_V_strb_V, end_str());
}

// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_s_axis_tx_data_V_last_V, begin_str(AESL_transaction));
if (__xlx_apatb_param_s_axis_tx_data_stream_buf_final_size > 0) {
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_s_axis_tx_data_V_last_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_tx_data_V_data_V, begin_str(AESL_transaction));
...
aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_tx_data_V_data_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_tx_data_V_keep_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_s_axis_tx_data_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_tx_data_V_keep_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_tx_data_V_keep_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_tx_data_V_strb_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_s_axis_tx_data_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_tx_data_V_strb_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_tx_data_V_strb_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_tx_data_V_last_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_s_axis_tx_data_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_tx_data_V_last_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_tx_data_V_last_V, end_str());
}
long __xlx_apatb_param_m_axis_tx_meta_stream_buf_final_size = ((hls::stream<long long>*)__xlx_apatb_param_m_axis_tx_meta)->size() - __xlx_apatb_param_m_axis_tx_meta_stream_buf_size;
{
  while (!((hls::stream<long long>*)__xlx_apatb_param_m_axis_tx_meta)->empty())
    __xlx_apatb_param_m_axis_tx_meta_stream_buf.push_back(((hls::stream<long long>*)__xlx_apatb_param_m_axis_tx_meta)->read());
  for (int i = 0; i < __xlx_apatb_param_m_axis_tx_meta_stream_buf.size(); ++i)
    ((hls::stream<long long>*)__xlx_apatb_param_m_axis_tx_meta)->write(__xlx_apatb_param_m_axis_tx_meta_stream_buf[i]);
  }
// print m_axis_tx_meta Transactions
{
aesl_fh.write(AUTOTB_TVOUT_m_axis_tx_meta, begin_str(AESL_transaction));
for (int j = 0, e = __xlx_apatb_param_m_axis_tx_meta_stream_buf_final_size; j != e; ++j) {
sc_bv<48> __xlx_tmp_lv = ((long long*)&__xlx_apatb_param_m_axis_tx_meta_stream_buf[__xlx_apatb_param_m_axis_tx_meta_stream_buf_size+j])[0];
aesl_fh.write(AUTOTB_TVOUT_m_axis_tx_meta, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}

  tcl_file.set_num(__xlx_apatb_param_m_axis_tx_meta_stream_buf_final_size, &tcl_file.m_axis_tx_meta_depth);
aesl_fh.write(AUTOTB_TVOUT_m_axis_tx_meta, end_str());
}

{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_tx_meta, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_m_axis_tx_meta_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_tx_meta, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_tx_meta, end_str());
}
