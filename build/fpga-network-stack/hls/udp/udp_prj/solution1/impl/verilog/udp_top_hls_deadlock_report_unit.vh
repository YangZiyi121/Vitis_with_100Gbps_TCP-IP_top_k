    ...
    function [512:0] proc_path(input [PROC_NUM - 1:0] dl_vec);
        ...
        begin
            ...
            case (index)
                ...
                4 : begin
                    proc_path = "udp_top_udp_top.convert_net_axis_to_axis_512_1_U0";
                end
                5 : begin
                ...
                10 : begin
                    ...
                    4: begin
                        if (~generate_udp_512_U0.m_axis_tx_data_internal_blk_n) begin
                            if (~m_axis_tx_data_internal_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'udp_top_udp_top.m_axis_tx_data_internal_U' written by process 'udp_top_udp_top.convert_net_axis_to_axis_512_1_U0'");
                                $fdisplay(fp, "Dependence_Channel_path udp_top_udp_top.m_axis_tx_data_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~m_axis_tx_data_internal_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'udp_top_udp_top.m_axis_tx_data_internal_U' read by process 'udp_top_udp_top.convert_net_axis_to_axis_512_1_U0'");
                                $fdisplay(fp, "Dependence_Channel_path udp_top_udp_top.m_axis_tx_data_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
