...
set solution_dir "/home/yangz0e/Desktop/Vitis_with_100Gbps_TCP-IP_top_k/build/fpga-network-stack/hls/toe/toe_prj/solution1"
set debug_dir "/home/yangz0e/Desktop/Vitis_with_100Gbps_TCP-IP_top_k/build/fpga-network-stack/hls/toe/toe_prj/solution1/.debug"
...
set Interfaces {
    ...
    s_axis_txwrite_sts {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_txwrite_sts"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    m_axis_txwrite_cmd {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_txwrite_cmd"
        has_tready "1"
        ports {
            TDATA 72
        }
    ...
    s_axis_session_lup_rsp {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_session_lup_rsp"
        has_tready "1"
        ports {
            TDATA 120
        }
    ...
    s_axis_session_upd_rsp {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_session_upd_rsp"
        has_tready "1"
        ports {
            TDATA 152
        }
    ...
    m_axis_session_lup_req {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_session_lup_req"
        has_tready "1"
        ports {
            TDATA 96
        }
    ...
    m_axis_session_upd_req {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_session_upd_req"
        has_tready "1"
        ports {
            TDATA 144
        }
    ...
    s_axis_listen_port_req {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_listen_port_req"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    s_axis_rx_data_req {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_rx_data_req"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    s_axis_open_conn_req {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_open_conn_req"
        has_tready "1"
        ports {
            TDATA 48
        }
    ...
    s_axis_close_conn_req {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_close_conn_req"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    s_axis_tx_data_req_metadata {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_tx_data_req_metadata"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    m_axis_listen_port_rsp {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_listen_port_rsp"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    m_axis_notification {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_notification"
        has_tready "1"
        ports {
            TDATA 88
        }
    ...
    m_axis_rx_data_rsp_metadata {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_rx_data_rsp_metadata"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    m_axis_open_conn_rsp {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_open_conn_rsp"
        has_tready "1"
        ports {
            TDATA 72
        }
    ...
    m_axis_tx_data_rsp {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_tx_data_rsp"
        has_tready "1"
        ports {
            TDATA 64
        }
