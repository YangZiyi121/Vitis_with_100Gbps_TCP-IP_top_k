...
set C_modelArgList {
	{ txApp2eventEng_mergeEvent int 85 regular {fifo 0 volatile } {global 0}  }
	{ txApp2eventEng_setEvent int 85 regular {fifo 1 volatile } {global 1}  }
	{ txAppStream2event_mergeEvent int 85 regular {fifo 0 volatile } {global 0}  }
	{ txApp_txEventCache int 85 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "txApp2eventEng_mergeEvent", "interface" : "fifo", "bitwidth" : 85, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "txApp2eventEng_setEvent", "interface" : "fifo", "bitwidth" : 85, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "txAppStream2event_mergeEvent", "interface" : "fifo", "bitwidth" : 85, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "txApp_txEventCache", "interface" : "fifo", "bitwidth" : 85, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "txApp2eventEng_mergeEvent_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":85, "type": "signal", "bundle":{"name": "txApp2eventEng_mergeEvent", "role": "dout" }} , 
 	...
 	{ "name": "txAppStream2event_mergeEvent_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":85, "type": "signal", "bundle":{"name": "txAppStream2event_mergeEvent", "role": "dout" }} , 
 	...
 	{ "name": "txApp2eventEng_setEvent_din", "direction": "out", "datatype": "sc_lv", "bitwidth":85, "type": "signal", "bundle":{"name": "txApp2eventEng_setEvent", "role": "din" }} , 
 	...
 	{ "name": "txApp_txEventCache_din", "direction": "out", "datatype": "sc_lv", "bitwidth":85, "type": "signal", "bundle":{"name": "txApp_txEventCache", "role": "din" }} , 
...
set Spec2ImplPortList { 
	txApp2eventEng_mergeEvent { ap_fifo {  { txApp2eventEng_mergeEvent_dout fifo_data 0 85 }  { txApp2eventEng_mergeEvent_empty_n fifo_status 0 1 }  { txApp2eventEng_mergeEvent_read fifo_update 1 1 } } }
	txApp2eventEng_setEvent { ap_fifo {  { txApp2eventEng_setEvent_din fifo_data 1 85 }  { txApp2eventEng_setEvent_full_n fifo_status 0 1 }  { txApp2eventEng_setEvent_write fifo_update 1 1 } } }
	txAppStream2event_mergeEvent { ap_fifo {  { txAppStream2event_mergeEvent_dout fifo_data 0 85 }  { txAppStream2event_mergeEvent_empty_n fifo_status 0 1 }  { txAppStream2event_mergeEvent_read fifo_update 1 1 } } }
	txApp_txEventCache { ap_fifo {  { txApp_txEventCache_din fifo_data 1 85 }  { txApp_txEventCache_full_n fifo_status 0 1 }  { txApp_txEventCache_write fifo_update 1 1 } } }
}
