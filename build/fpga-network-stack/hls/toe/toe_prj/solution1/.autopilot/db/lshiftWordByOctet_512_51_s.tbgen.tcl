...
set C_modelArgList {
	{ txEng_shift2pseudoFifo int 577 regular {fifo 1 volatile } {global 1}  }
	{ txEng_tcpPkgBuffer0 int 577 regular {fifo 0 volatile } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "txEng_shift2pseudoFifo", "interface" : "fifo", "bitwidth" : 577, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "txEng_tcpPkgBuffer0", "interface" : "fifo", "bitwidth" : 577, "direction" : "READONLY", "extern" : 0} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "txEng_tcpPkgBuffer0_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":577, "type": "signal", "bundle":{"name": "txEng_tcpPkgBuffer0", "role": "dout" }} , 
 	...
 	{ "name": "txEng_shift2pseudoFifo_din", "direction": "out", "datatype": "sc_lv", "bitwidth":577, "type": "signal", "bundle":{"name": "txEng_shift2pseudoFifo", "role": "din" }} , 
...
set Spec2ImplPortList { 
	txEng_shift2pseudoFifo { ap_fifo {  { txEng_shift2pseudoFifo_din fifo_data 1 577 }  { txEng_shift2pseudoFifo_full_n fifo_status 0 1 }  { txEng_shift2pseudoFifo_write fifo_update 1 1 } } }
	txEng_tcpPkgBuffer0 { ap_fifo {  { txEng_tcpPkgBuffer0_dout fifo_data 0 577 }  { txEng_tcpPkgBuffer0_empty_n fifo_status 0 1 }  { txEng_tcpPkgBuffer0_read fifo_update 1 1 } } }
}
