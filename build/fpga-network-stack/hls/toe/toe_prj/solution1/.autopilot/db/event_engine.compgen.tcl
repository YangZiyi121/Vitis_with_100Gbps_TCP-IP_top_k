...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { rxEng2eventEng_setEvent_dout { I 181 vector } rxEng2eventEng_setEvent_empty_n { I 1 bit } rxEng2eventEng_setEvent_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { eventEng2ackDelay_event_din { O 181 vector } eventEng2ackDelay_event_full_n { I 1 bit } eventEng2ackDelay_event_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { timer2eventEng_setEvent_dout { I 85 vector } timer2eventEng_setEvent_empty_n { I 1 bit } timer2eventEng_setEvent_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { txApp2eventEng_setEvent_dout { I 85 vector } txApp2eventEng_setEvent_empty_n { I 1 bit } txApp2eventEng_setEvent_read { O 1 bit } } \
} "
}
