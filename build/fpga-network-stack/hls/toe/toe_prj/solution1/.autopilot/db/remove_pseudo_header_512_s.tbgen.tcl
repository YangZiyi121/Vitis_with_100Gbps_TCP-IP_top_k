...
set C_modelArgList {
	{ txEng_tcpPkgBuffer2 int 577 regular {fifo 0 volatile } {global 0}  }
	{ txEng_tcpPkgBuffer3 int 577 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "txEng_tcpPkgBuffer2", "interface" : "fifo", "bitwidth" : 577, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "txEng_tcpPkgBuffer3", "interface" : "fifo", "bitwidth" : 577, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "txEng_tcpPkgBuffer2_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":577, "type": "signal", "bundle":{"name": "txEng_tcpPkgBuffer2", "role": "dout" }} , 
 	...
 	{ "name": "txEng_tcpPkgBuffer3_din", "direction": "out", "datatype": "sc_lv", "bitwidth":577, "type": "signal", "bundle":{"name": "txEng_tcpPkgBuffer3", "role": "din" }} , 
...
set Spec2ImplPortList { 
	txEng_tcpPkgBuffer2 { ap_fifo {  { txEng_tcpPkgBuffer2_dout fifo_data 0 577 }  { txEng_tcpPkgBuffer2_empty_n fifo_status 0 1 }  { txEng_tcpPkgBuffer2_read fifo_update 1 1 } } }
	txEng_tcpPkgBuffer3 { ap_fifo {  { txEng_tcpPkgBuffer3_din fifo_data 1 577 }  { txEng_tcpPkgBuffer3_full_n fifo_status 0 1 }  { txEng_tcpPkgBuffer3_write fifo_update 1 1 } } }
}
