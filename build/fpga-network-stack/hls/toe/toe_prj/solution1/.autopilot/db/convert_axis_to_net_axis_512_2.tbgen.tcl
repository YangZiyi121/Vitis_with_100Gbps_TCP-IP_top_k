set moduleName convert_axis_to_net_axis_512_2
set isTopModule 0
...
set C_modelName {convert_axis_to_net_axis<512>.2}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_txread_data_V_data_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_txread_data_V_keep_V_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_txread_data_V_strb_V_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_txread_data_V_last_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	s_axis_txread_data_V_last_V { axis {  { s_axis_txread_data_TVALID in_vld 0 1 }  { s_axis_txread_data_TREADY in_acc 1 1 }  { s_axis_txread_data_TLAST in_data 0 1 } } }
