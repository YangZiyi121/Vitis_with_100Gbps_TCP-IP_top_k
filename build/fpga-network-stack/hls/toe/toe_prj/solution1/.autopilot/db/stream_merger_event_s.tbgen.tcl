...
set C_modelArgList {
	{ rtTimer2eventEng_setEvent int 85 regular {fifo 0 volatile } {global 0}  }
	{ timer2eventEng_setEvent int 85 regular {fifo 1 volatile } {global 1}  }
	{ probeTimer2eventEng_setEvent int 85 regular {fifo 0 volatile } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "rtTimer2eventEng_setEvent", "interface" : "fifo", "bitwidth" : 85, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "timer2eventEng_setEvent", "interface" : "fifo", "bitwidth" : 85, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "probeTimer2eventEng_setEvent", "interface" : "fifo", "bitwidth" : 85, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ timer2eventEng_setEvent_din sc_out sc_lv 85 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rtTimer2eventEng_setEvent_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":85, "type": "signal", "bundle":{"name": "rtTimer2eventEng_setEvent", "role": "dout" }} , 
 	...
 	{ "name": "probeTimer2eventEng_setEvent_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":85, "type": "signal", "bundle":{"name": "probeTimer2eventEng_setEvent", "role": "dout" }} , 
 	...
 	{ "name": "timer2eventEng_setEvent_din", "direction": "out", "datatype": "sc_lv", "bitwidth":85, "type": "signal", "bundle":{"name": "timer2eventEng_setEvent", "role": "din" }} , 
...
set Spec2ImplPortList { 
	rtTimer2eventEng_setEvent { ap_fifo {  { rtTimer2eventEng_setEvent_dout fifo_data 0 85 }  { rtTimer2eventEng_setEvent_empty_n fifo_status 0 1 }  { rtTimer2eventEng_setEvent_read fifo_update 1 1 } } }
	timer2eventEng_setEvent { ap_fifo {  { timer2eventEng_setEvent_din fifo_data 1 85 }  { timer2eventEng_setEvent_full_n fifo_status 0 1 }  { timer2eventEng_setEvent_write fifo_update 1 1 } } }
	probeTimer2eventEng_setEvent { ap_fifo {  { probeTimer2eventEng_setEvent_dout fifo_data 0 85 }  { probeTimer2eventEng_setEvent_empty_n fifo_status 0 1 }  { probeTimer2eventEng_setEvent_read fifo_update 1 1 } } }
}
