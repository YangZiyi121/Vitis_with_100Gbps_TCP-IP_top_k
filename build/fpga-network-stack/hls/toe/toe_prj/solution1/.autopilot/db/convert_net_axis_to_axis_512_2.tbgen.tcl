set moduleName convert_net_axis_to_axis_512_2
set isTopModule 0
...
set C_modelName {convert_net_axis_to_axis<512>.2}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_txwrite_data_V_data_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_txwrite_data_V_keep_V_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_txwrite_data_V_strb_V_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_txwrite_data_V_last_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	m_axis_txwrite_data_V_last_V { axis {  { m_axis_txwrite_data_TREADY out_acc 0 1 }  { m_axis_txwrite_data_TVALID out_vld 1 1 }  { m_axis_txwrite_data_TLAST out_data 1 1 } } }
