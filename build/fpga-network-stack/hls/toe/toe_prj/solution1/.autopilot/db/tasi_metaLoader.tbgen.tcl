...
set C_modelArgList {
	...
	{ txApp2txSar_upd_req int 35 regular {fifo 1 volatile } {global 1}  }
	{ txSar2txApp_upd_rsp int 70 regular {fifo 0 volatile } {global 0}  }
	{ stateTable2txApp_rsp int 32 regular {fifo 0 volatile } {global 0}  }
	{ tasi_meta2pkgPushCmd int 72 regular {fifo 1 volatile } {global 1}  }
	{ txAppStream2event_mergeEvent int 85 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_tx_data_req_metadata", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "txApp2txSar_upd_req", "interface" : "fifo", "bitwidth" : 35, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "txSar2txApp_upd_rsp", "interface" : "fifo", "bitwidth" : 70, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "stateTable2txApp_rsp", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "tasi_meta2pkgPushCmd", "interface" : "fifo", "bitwidth" : 72, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "txAppStream2event_mergeEvent", "interface" : "fifo", "bitwidth" : 85, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ s_axis_tx_data_req_metadata_TVALID sc_in sc_logic 1 invld 0 } 
	...
	{ txSar2txApp_upd_rsp_dout sc_in sc_lv 70 signal 4 } 
	...
	{ s_axis_tx_data_req_metadata_TDATA sc_in sc_lv 32 signal 0 } 
	{ s_axis_tx_data_req_metadata_TREADY sc_out sc_logic 1 inacc 0 } 
	{ m_axis_tx_data_rsp_TDATA sc_out sc_lv 64 signal 1 } 
	{ m_axis_tx_data_rsp_TVALID sc_out sc_logic 1 outvld 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "txSar2txApp_upd_rsp_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":70, "type": "signal", "bundle":{"name": "txSar2txApp_upd_rsp", "role": "dout" }} , 
 	...
 	{ "name": "txApp2txSar_upd_req_din", "direction": "out", "datatype": "sc_lv", "bitwidth":35, "type": "signal", "bundle":{"name": "txApp2txSar_upd_req", "role": "din" }} , 
 	...
 	{ "name": "tasi_meta2pkgPushCmd_din", "direction": "out", "datatype": "sc_lv", "bitwidth":72, "type": "signal", "bundle":{"name": "tasi_meta2pkgPushCmd", "role": "din" }} , 
 	...
 	{ "name": "txAppStream2event_mergeEvent_din", "direction": "out", "datatype": "sc_lv", "bitwidth":85, "type": "signal", "bundle":{"name": "txAppStream2event_mergeEvent", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_tx_data_req_metadata_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_tx_data_rsp_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	s_axis_tx_data_req_metadata { axis {  { s_axis_tx_data_req_metadata_TVALID in_vld 0 1 }  { s_axis_tx_data_req_metadata_TDATA in_data 0 32 }  { s_axis_tx_data_req_metadata_TREADY in_acc 1 1 } } }
	m_axis_tx_data_rsp { axis {  { m_axis_tx_data_rsp_TREADY out_acc 0 1 }  { m_axis_tx_data_rsp_TDATA out_data 1 64 }  { m_axis_tx_data_rsp_TVALID out_vld 1 1 } } }
	...
	txApp2txSar_upd_req { ap_fifo {  { txApp2txSar_upd_req_din fifo_data 1 35 }  { txApp2txSar_upd_req_full_n fifo_status 0 1 }  { txApp2txSar_upd_req_write fifo_update 1 1 } } }
	txSar2txApp_upd_rsp { ap_fifo {  { txSar2txApp_upd_rsp_dout fifo_data 0 70 }  { txSar2txApp_upd_rsp_empty_n fifo_status 0 1 }  { txSar2txApp_upd_rsp_read fifo_update 1 1 } } }
	...
	tasi_meta2pkgPushCmd { ap_fifo {  { tasi_meta2pkgPushCmd_din fifo_data 1 72 }  { tasi_meta2pkgPushCmd_full_n fifo_status 0 1 }  { tasi_meta2pkgPushCmd_write fifo_update 1 1 } } }
	txAppStream2event_mergeEvent { ap_fifo {  { txAppStream2event_mergeEvent_din fifo_data 1 85 }  { txAppStream2event_mergeEvent_full_n fifo_status 0 1 }  { txAppStream2event_mergeEvent_write fifo_update 1 1 } } }
}
