...
begin
    regslice_both_s_axis_rx_data_V_data_V_U : component ipv4_top_regslice_both
    generic map (
        DataWidth => 512)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_rx_data_V_keep_V_U : component ipv4_top_regslice_both
    generic map (
        DataWidth => 64)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_rx_data_V_strb_V_U : component ipv4_top_regslice_both
    generic map (
        DataWidth => 64)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_rx_data_V_last_V_U : component ipv4_top_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
