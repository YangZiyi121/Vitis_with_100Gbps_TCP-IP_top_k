...
extern "C" void ipv4_top(volatile void *, volatile void *, volatile void *, , volatile void *, , , long long*, volatile void *, volatile void *, volatile void *, , volatile void *, , , long long*, volatile void *, volatile void *, volatile void *, , volatile void *, , , volatile void *, volatile void *, volatile void *, , volatile void *, , , __cosim_s4__, __cosim_s1__);
extern "C" void apatb_ipv4_top_hw(volatile void * __xlx_apatb_param_s_axis_rx_data_V_data_V, volatile void * __xlx_apatb_param_s_axis_rx_data_V_keep_V, volatile void * __xlx_apatb_param_s_axis_rx_data_V_strb_V, volatile void * __xlx_apatb_param_s_axis_rx_data_V_last_V, volatile void * __xlx_apatb_param_m_axis_rx_meta, volatile void * __xlx_apatb_param_m_axis_rx_data_V_data_V, volatile void * __xlx_apatb_param_m_axis_rx_data_V_keep_V, volatile void * __xlx_apatb_param_m_axis_rx_data_V_strb_V, volatile void * __xlx_apatb_param_m_axis_rx_data_V_last_V, volatile void * __xlx_apatb_param_s_axis_tx_meta, volatile void * __xlx_apatb_param_s_axis_tx_data_V_data_V, volatile void * __xlx_apatb_param_s_axis_tx_data_V_keep_V, volatile void * __xlx_apatb_param_s_axis_tx_data_V_strb_V, volatile void * __xlx_apatb_param_s_axis_tx_data_V_last_V, volatile void * __xlx_apatb_param_m_axis_tx_data_V_data_V, volatile void * __xlx_apatb_param_m_axis_tx_data_V_keep_V, volatile void * __xlx_apatb_param_m_axis_tx_data_V_strb_V, volatile void * __xlx_apatb_param_m_axis_tx_data_V_last_V, __cosim_s4__* __xlx_apatb_param_local_ipv4_address, __cosim_s1__* __xlx_apatb_param_protocol) {
  ...
  long long* __xlx_m_axis_rx_meta_input_buffer= new long long[ap_apatb_m_axis_rx_meta_cap_bc];
  ...
  vector<long long> __xlx_s_axis_tx_meta_tmp_vec;
  while (!((hls::stream<long long>*)__xlx_apatb_param_s_axis_tx_meta)->empty() && __xlx_s_axis_tx_meta_V_tmp_Count < __xlx_s_axis_tx_meta_V_read_Size) {
    __xlx_s_axis_tx_meta_tmp_vec.push_back(((hls::stream<long long>*)__xlx_apatb_param_s_axis_tx_meta)->read());
    __xlx_s_axis_tx_meta_V_tmp_Count++;
  }
  ap_apatb_s_axis_tx_meta_cap_bc = __xlx_s_axis_tx_meta_tmp_vec.size();
  // store input buffer
  long long* __xlx_s_axis_tx_meta_input_buffer= new long long[__xlx_s_axis_tx_meta_tmp_vec.size()];
  ...
  // DUT call
  ipv4_top(__xlx_s_axis_rx_data_V_data_V_input_buffer, __xlx_s_axis_rx_data_V_keep_V_input_buffer, __xlx_s_axis_rx_data_V_strb_V_input_buffer, __xlx_s_axis_rx_data_V_last_V_input_buffer, __xlx_m_axis_rx_meta_input_buffer, __xlx_m_axis_rx_data_V_data_V_input_buffer, __xlx_m_axis_rx_data_V_keep_V_input_buffer, __xlx_m_axis_rx_data_V_strb_V_input_buffer, __xlx_m_axis_rx_data_V_last_V_input_buffer, __xlx_s_axis_tx_meta_input_buffer, __xlx_s_axis_tx_data_V_data_V_input_buffer, __xlx_s_axis_tx_data_V_keep_V_input_buffer, __xlx_s_axis_tx_data_V_strb_V_input_buffer, __xlx_s_axis_tx_data_V_last_V_input_buffer, __xlx_m_axis_tx_data_V_data_V_input_buffer, __xlx_m_axis_tx_data_V_keep_V_input_buffer, __xlx_m_axis_tx_data_V_strb_V_input_buffer, __xlx_m_axis_tx_data_V_last_V_input_buffer, *__xlx_apatb_param_local_ipv4_address, *__xlx_apatb_param_protocol);
  for (unsigned i = 0; i <ap_apatb_m_axis_rx_meta_cap_bc; ++i)
    ((hls::stream<long long>*)__xlx_apatb_param_m_axis_rx_meta)->write(__xlx_m_axis_rx_meta_input_buffer[i]);
