...
set portList { 
	...
	{ m_axis_rx_meta_TREADY sc_in sc_logic 1 outacc 0 } 
	...
	{ m_axis_rx_meta_TDATA sc_out sc_lv 48 signal 0 } 
	{ m_axis_rx_meta_TVALID sc_out sc_logic 1 outvld 0 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_rx_meta_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	m_axis_rx_meta { axis {  { m_axis_rx_meta_TREADY out_acc 0 1 }  { m_axis_rx_meta_TDATA out_data 1 48 }  { m_axis_rx_meta_TVALID out_vld 1 1 } } }
