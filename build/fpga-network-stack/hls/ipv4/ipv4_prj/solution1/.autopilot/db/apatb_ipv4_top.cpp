...
// wrapc file define:
#define AUTOTB_TVIN_m_axis_rx_meta "../tv/cdatafile/c.ipv4_top.autotvin_m_axis_rx_meta.dat"
#define AUTOTB_TVOUT_m_axis_rx_meta "../tv/cdatafile/c.ipv4_top.autotvout_m_axis_rx_meta.dat"
...
// wrapc file define:
#define AUTOTB_TVIN_s_axis_tx_meta "../tv/cdatafile/c.ipv4_top.autotvin_s_axis_tx_meta.dat"
#define AUTOTB_TVOUT_s_axis_tx_meta "../tv/cdatafile/c.ipv4_top.autotvout_s_axis_tx_meta.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_m_axis_rx_meta "../tv/rtldatafile/rtl.ipv4_top.autotvout_m_axis_rx_meta.dat"
// tvout file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_s_axis_tx_meta "../tv/rtldatafile/rtl.ipv4_top.autotvout_s_axis_tx_meta.dat"
// tvout file define:
...
long __xlx_apatb_param_m_axis_rx_meta_stream_buf_final_size;
{
    ...
    } // end post check logic bolck
  {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<48> > m_axis_rx_meta_pc_buffer;
          int i = 0;
...
((char*)&xlx_stream_elt)[0*8+0] = m_axis_rx_meta_pc_buffer[j].range(7, 0).to_int64();
((char*)&xlx_stream_elt)[0*8+1] = m_axis_rx_meta_pc_buffer[j].range(15, 8).to_int64();
((char*)&xlx_stream_elt)[0*8+2] = m_axis_rx_meta_pc_buffer[j].range(23, 16).to_int64();
((char*)&xlx_stream_elt)[0*8+3] = m_axis_rx_meta_pc_buffer[j].range(31, 24).to_int64();
((char*)&xlx_stream_elt)[0*8+4] = m_axis_rx_meta_pc_buffer[j].range(39, 32).to_int64();
((char*)&xlx_stream_elt)[0*8+5] = m_axis_rx_meta_pc_buffer[j].range(47, 40).to_int64();
((hls::stream<long long>*)__xlx_apatb_param_m_axis_rx_meta)->write(xlx_stream_elt);
}
}
        } // end transaction
      } // end file is good
...
}}long __xlx_apatb_param_s_axis_tx_meta_stream_buf_final_size;
{
  ...
  for (long i = 0; i < __xlx_apatb_param_s_axis_tx_meta_stream_buf_final_size; ++i)((hls::stream<long long>*)__xlx_apatb_param_s_axis_tx_meta)->read();
...
// id
// dest
std::vector<long long> __xlx_apatb_param_m_axis_rx_meta_stream_buf;
long __xlx_apatb_param_m_axis_rx_meta_stream_buf_size = ((hls::stream<long long>*)__xlx_apatb_param_m_axis_rx_meta)->size();
// data
...
// id
// dest
std::vector<long long> __xlx_apatb_param_s_axis_tx_meta_stream_buf;
{
  while (!((hls::stream<long long>*)__xlx_apatb_param_s_axis_tx_meta)->empty())
    __xlx_apatb_param_s_axis_tx_meta_stream_buf.push_back(((hls::stream<long long>*)__xlx_apatb_param_s_axis_tx_meta)->read());
  for (int i = 0; i < __xlx_apatb_param_s_axis_tx_meta_stream_buf.size(); ++i)
    ((hls::stream<long long>*)__xlx_apatb_param_s_axis_tx_meta)->write(__xlx_apatb_param_s_axis_tx_meta_stream_buf[i]);
  }
long __xlx_apatb_param_s_axis_tx_meta_stream_buf_size = ((hls::stream<long long>*)__xlx_apatb_param_s_axis_tx_meta)->size();
// data
...
long __xlx_apatb_param_m_axis_rx_meta_stream_buf_final_size = ((hls::stream<long long>*)__xlx_apatb_param_m_axis_rx_meta)->size() - __xlx_apatb_param_m_axis_rx_meta_stream_buf_size;
{
  while (!((hls::stream<long long>*)__xlx_apatb_param_m_axis_rx_meta)->empty())
    __xlx_apatb_param_m_axis_rx_meta_stream_buf.push_back(((hls::stream<long long>*)__xlx_apatb_param_m_axis_rx_meta)->read());
  for (int i = 0; i < __xlx_apatb_param_m_axis_rx_meta_stream_buf.size(); ++i)
    ((hls::stream<long long>*)__xlx_apatb_param_m_axis_rx_meta)->write(__xlx_apatb_param_m_axis_rx_meta_stream_buf[i]);
  }
...
sc_bv<48> __xlx_tmp_lv = ((long long*)&__xlx_apatb_param_m_axis_rx_meta_stream_buf[__xlx_apatb_param_m_axis_rx_meta_stream_buf_size+j])[0];
...
long __xlx_apatb_param_s_axis_tx_meta_stream_buf_final_size = __xlx_apatb_param_s_axis_tx_meta_stream_buf_size - ((hls::stream<long long>*)__xlx_apatb_param_s_axis_tx_meta)->size();
