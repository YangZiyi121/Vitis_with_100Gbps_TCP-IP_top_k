...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_rx_meta_TDATA { O 48 vector } m_axis_rx_meta_TVALID { O 1 bit } m_axis_rx_meta_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_tx_meta_TDATA { I 48 vector } s_axis_tx_meta_TVALID { I 1 bit } s_axis_tx_meta_TREADY { O 1 bit } } \
} "
} else {
