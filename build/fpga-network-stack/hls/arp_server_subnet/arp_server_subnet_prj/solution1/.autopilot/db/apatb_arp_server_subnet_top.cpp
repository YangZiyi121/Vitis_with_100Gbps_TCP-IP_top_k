...
extern "C" void arp_server_subnet_top_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, __cosim_s8__*, __cosim_s4__*, volatile void *, volatile void *);

extern "C" void apatb_arp_server_subnet_top_hw(volatile void * __xlx_apatb_param_s_axis_V_data_V, volatile void * __xlx_apatb_param_s_axis_V_keep_V, volatile void * __xlx_apatb_param_s_axis_V_strb_V, volatile void * __xlx_apatb_param_s_axis_V_last_V, volatile void * __xlx_apatb_param_s_axis_arp_lookup_request, volatile void * __xlx_apatb_param_s_axis_host_arp_lookup_request, volatile void * __xlx_apatb_param_m_axis_V_data_V, volatile void * __xlx_apatb_param_m_axis_V_keep_V, volatile void * __xlx_apatb_param_m_axis_V_strb_V, volatile void * __xlx_apatb_param_m_axis_V_last_V, volatile void * __xlx_apatb_param_m_axis_arp_lookup_reply, volatile void * __xlx_apatb_param_m_axis_host_arp_lookup_reply, __cosim_s8__* __xlx_apatb_param_myMacAddress, __cosim_s4__* __xlx_apatb_param_myIpAddress, volatile void * __xlx_apatb_param_regRequestCount, volatile void * __xlx_apatb_param_regReplyCount) {
...
((hls::stream<__cosim_s40__>*)__xlx_apatb_param_s_axis_V_data_V)->read();
((hls::stream<long long>*)__xlx_apatb_param_s_axis_V_keep_V)->read();
((hls::stream<long long>*)__xlx_apatb_param_s_axis_V_strb_V)->read();
...
((long long*)&xlx_stream_elt_data)[0*8+0] = m_axis_V_data_V_pc_buffer_Copy[j].range(63,0).to_int64();
((long long*)&xlx_stream_elt_data)[0*8+1] = m_axis_V_data_V_pc_buffer_Copy[j].range(127,64).to_int64();
((long long*)&xlx_stream_elt_data)[0*8+2] = m_axis_V_data_V_pc_buffer_Copy[j].range(191,128).to_int64();
((long long*)&xlx_stream_elt_data)[0*8+3] = m_axis_V_data_V_pc_buffer_Copy[j].range(255,192).to_int64();
((long long*)&xlx_stream_elt_data)[0*8+4] = m_axis_V_data_V_pc_buffer_Copy[j].range(319,256).to_int64();
((long long*)&xlx_stream_elt_data)[0*8+5] = m_axis_V_data_V_pc_buffer_Copy[j].range(383,320).to_int64();
((long long*)&xlx_stream_elt_data)[0*8+6] = m_axis_V_data_V_pc_buffer_Copy[j].range(447,384).to_int64();
((long long*)&xlx_stream_elt_data)[0*8+7] = m_axis_V_data_V_pc_buffer_Copy[j].range(511,448).to_int64();
((hls::stream<__cosim_s40__>*)__xlx_apatb_param_m_axis_V_data_V)->write(xlx_stream_elt_data);
long long xlx_stream_elt_keep;
((long long*)&xlx_stream_elt_keep)[0] = m_axis_V_keep_V_pc_buffer_Copy[j].to_int64();
((hls::stream<long long>*)__xlx_apatb_param_m_axis_V_keep_V)->write(xlx_stream_elt_keep);
long long xlx_stream_elt_strb;
((long long*)&xlx_stream_elt_strb)[0] = m_axis_V_strb_V_pc_buffer_Copy[j].to_int64();
((hls::stream<long long>*)__xlx_apatb_param_m_axis_V_strb_V)->write(xlx_stream_elt_strb);
...
}}long __xlx_apatb_param_m_axis_arp_lookup_reply_stream_buf_final_size;
{
    ...
    } // end post check logic bolck
  {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<56> > m_axis_arp_lookup_reply_pc_buffer;
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){

            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "m_axis_arp_lookup_reply");
...
((char*)&xlx_stream_elt)[0*8+0] = m_axis_arp_lookup_reply_pc_buffer[j].range(7, 0).to_int64();
((char*)&xlx_stream_elt)[0*8+1] = m_axis_arp_lookup_reply_pc_buffer[j].range(15, 8).to_int64();
((char*)&xlx_stream_elt)[0*8+2] = m_axis_arp_lookup_reply_pc_buffer[j].range(23, 16).to_int64();
((char*)&xlx_stream_elt)[0*8+3] = m_axis_arp_lookup_reply_pc_buffer[j].range(31, 24).to_int64();
((char*)&xlx_stream_elt)[0*8+4] = m_axis_arp_lookup_reply_pc_buffer[j].range(39, 32).to_int64();
((char*)&xlx_stream_elt)[0*8+5] = m_axis_arp_lookup_reply_pc_buffer[j].range(47, 40).to_int64();
((char*)&xlx_stream_elt)[0*8+6] = m_axis_arp_lookup_reply_pc_buffer[j].range(55, 48).to_int64();
((hls::stream<long long>*)__xlx_apatb_param_m_axis_arp_lookup_reply)->write(xlx_stream_elt);
}
}
        } // end transaction
      } // end file is good
  ...
  long __xlx_apatb_param_m_axis_host_arp_lookup_reply_stream_buf_final_size;
{
    ...
    } // end post check logic bolck
  {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<56> > m_axis_host_arp_lookup_reply_pc_buffer;
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){

            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "m_axis_host_arp_lookup_reply");
          ...
          if (i > 0) {for (int j = 0, e = i; j != e; ++j) {
long long xlx_stream_elt;
((char*)&xlx_stream_elt)[0*8+0] = m_axis_host_arp_lookup_reply_pc_buffer[j].range(7, 0).to_int64();
((char*)&xlx_stream_elt)[0*8+1] = m_axis_host_arp_lookup_reply_pc_buffer[j].range(15, 8).to_int64();
((char*)&xlx_stream_elt)[0*8+2] = m_axis_host_arp_lookup_reply_pc_buffer[j].range(23, 16).to_int64();
((char*)&xlx_stream_elt)[0*8+3] = m_axis_host_arp_lookup_reply_pc_buffer[j].range(31, 24).to_int64();
((char*)&xlx_stream_elt)[0*8+4] = m_axis_host_arp_lookup_reply_pc_buffer[j].range(39, 32).to_int64();
((char*)&xlx_stream_elt)[0*8+5] = m_axis_host_arp_lookup_reply_pc_buffer[j].range(47, 40).to_int64();
((char*)&xlx_stream_elt)[0*8+6] = m_axis_host_arp_lookup_reply_pc_buffer[j].range(55, 48).to_int64();
((hls::stream<long long>*)__xlx_apatb_param_m_axis_host_arp_lookup_reply)->write(xlx_stream_elt);
}
}
        } // end transaction
      } // end file is good
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          while (AESL_token != "[[/transaction]]"){
            ...
            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "regRequestCount");
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          while (AESL_token != "[[/transaction]]"){
            ...
            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "regReplyCount");
...
// data
std::vector<__cosim_s40__> __xlx_apatb_param_s_axis_V_data_V_stream_buf;
{
  while (!((hls::stream<__cosim_s40__>*)__xlx_apatb_param_s_axis_V_data_V)->empty())
    __xlx_apatb_param_s_axis_V_data_V_stream_buf.push_back(((hls::stream<__cosim_s40__>*)__xlx_apatb_param_s_axis_V_data_V)->read());
  for (int i = 0; i < __xlx_apatb_param_s_axis_V_data_V_stream_buf.size(); ++i)
    ((hls::stream<__cosim_s40__>*)__xlx_apatb_param_s_axis_V_data_V)->write(__xlx_apatb_param_s_axis_V_data_V_stream_buf[i]);
  }
long __xlx_apatb_param_s_axis_stream_buf_size = ((hls::stream<__cosim_s40__>*)__xlx_apatb_param_s_axis_V_data_V)->size();
// keep
std::vector<long long> __xlx_apatb_param_s_axis_V_keep_V_stream_buf;
{
  while (!((hls::stream<long long>*)__xlx_apatb_param_s_axis_V_keep_V)->empty())
    __xlx_apatb_param_s_axis_V_keep_V_stream_buf.push_back(((hls::stream<long long>*)__xlx_apatb_param_s_axis_V_keep_V)->read());
  for (int i = 0; i < __xlx_apatb_param_s_axis_V_keep_V_stream_buf.size(); ++i)
    ((hls::stream<long long>*)__xlx_apatb_param_s_axis_V_keep_V)->write(__xlx_apatb_param_s_axis_V_keep_V_stream_buf[i]);
  }
// strb
std::vector<long long> __xlx_apatb_param_s_axis_V_strb_V_stream_buf;
{
  while (!((hls::stream<long long>*)__xlx_apatb_param_s_axis_V_strb_V)->empty())
    __xlx_apatb_param_s_axis_V_strb_V_stream_buf.push_back(((hls::stream<long long>*)__xlx_apatb_param_s_axis_V_strb_V)->read());
  for (int i = 0; i < __xlx_apatb_param_s_axis_V_strb_V_stream_buf.size(); ++i)
    ((hls::stream<long long>*)__xlx_apatb_param_s_axis_V_strb_V)->write(__xlx_apatb_param_s_axis_V_strb_V_stream_buf[i]);
  }
// user
// last
...
// data
std::vector<__cosim_s40__> __xlx_apatb_param_m_axis_V_data_V_stream_buf;
long __xlx_apatb_param_m_axis_stream_buf_size = ((hls::stream<__cosim_s40__>*)__xlx_apatb_param_m_axis_V_data_V)->size();
// keep
std::vector<long long> __xlx_apatb_param_m_axis_V_keep_V_stream_buf;
// strb
std::vector<long long> __xlx_apatb_param_m_axis_V_strb_V_stream_buf;
// user
// last
std::vector<char> __xlx_apatb_param_m_axis_V_last_V_stream_buf;
// id
// dest
std::vector<long long> __xlx_apatb_param_m_axis_arp_lookup_reply_stream_buf;
long __xlx_apatb_param_m_axis_arp_lookup_reply_stream_buf_size = ((hls::stream<long long>*)__xlx_apatb_param_m_axis_arp_lookup_reply)->size();
std::vector<long long> __xlx_apatb_param_m_axis_host_arp_lookup_reply_stream_buf;
long __xlx_apatb_param_m_axis_host_arp_lookup_reply_stream_buf_size = ((hls::stream<long long>*)__xlx_apatb_param_m_axis_host_arp_lookup_reply)->size();
...
aesl_fh.write(AUTOTB_TVIN_regRequestCount, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
...
aesl_fh.write(AUTOTB_TVIN_regReplyCount, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
...
arp_server_subnet_top_hw_stub_wrapper(__xlx_apatb_param_s_axis_V_data_V, __xlx_apatb_param_s_axis_V_keep_V, __xlx_apatb_param_s_axis_V_strb_V, __xlx_apatb_param_s_axis_V_last_V, __xlx_apatb_param_s_axis_arp_lookup_request, __xlx_apatb_param_s_axis_host_arp_lookup_request, __xlx_apatb_param_m_axis_V_data_V, __xlx_apatb_param_m_axis_V_keep_V, __xlx_apatb_param_m_axis_V_strb_V, __xlx_apatb_param_m_axis_V_last_V, __xlx_apatb_param_m_axis_arp_lookup_reply, __xlx_apatb_param_m_axis_host_arp_lookup_reply, __xlx_apatb_param_myMacAddress, __xlx_apatb_param_myIpAddress, __xlx_apatb_param_regRequestCount, __xlx_apatb_param_regReplyCount);
CodeState = DUMP_OUTPUTS;
long __xlx_apatb_param_s_axis_stream_buf_final_size = __xlx_apatb_param_s_axis_stream_buf_size - ((hls::stream<__cosim_s40__>*)__xlx_apatb_param_s_axis_V_data_V)->size();
...
__xlx_tmp_lv.range(63,0) = ((long long*)&__xlx_apatb_param_s_axis_V_data_V_stream_buf[j])[0*8+0];
__xlx_tmp_lv.range(127,64) = ((long long*)&__xlx_apatb_param_s_axis_V_data_V_stream_buf[j])[0*8+1];
__xlx_tmp_lv.range(191,128) = ((long long*)&__xlx_apatb_param_s_axis_V_data_V_stream_buf[j])[0*8+2];
__xlx_tmp_lv.range(255,192) = ((long long*)&__xlx_apatb_param_s_axis_V_data_V_stream_buf[j])[0*8+3];
__xlx_tmp_lv.range(319,256) = ((long long*)&__xlx_apatb_param_s_axis_V_data_V_stream_buf[j])[0*8+4];
__xlx_tmp_lv.range(383,320) = ((long long*)&__xlx_apatb_param_s_axis_V_data_V_stream_buf[j])[0*8+5];
__xlx_tmp_lv.range(447,384) = ((long long*)&__xlx_apatb_param_s_axis_V_data_V_stream_buf[j])[0*8+6];
__xlx_tmp_lv.range(511,448) = ((long long*)&__xlx_apatb_param_s_axis_V_data_V_stream_buf[j])[0*8+7];
__xlx_tmp_0_lv = __xlx_tmp_lv;
}
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_0_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVIN_s_axis_V_data_V, __xlx_sprintf_buffer.data());
sc_bv<64> __xlx_tmp_1_lv = ((long long*)&__xlx_apatb_param_s_axis_V_keep_V_stream_buf[j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_1_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVIN_s_axis_V_keep_V, __xlx_sprintf_buffer.data());
sc_bv<64> __xlx_tmp_2_lv = ((long long*)&__xlx_apatb_param_s_axis_V_strb_V_stream_buf[j])[0];
...
__xlx_tmp_lv_hw = __xlx_tmp_lv;
    ...
    aesl_fh.write(AUTOTB_TVIN_s_axis_arp_lookup_request, __xlx_sprintf_buffer.data()); 
  }
...
__xlx_tmp_lv_hw = __xlx_tmp_lv;
    ...
    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv_hw.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_s_axis_host_arp_lookup_request, __xlx_sprintf_buffer.data()); 
  }
...
long __xlx_apatb_param_m_axis_stream_buf_final_size = ((hls::stream<__cosim_s40__>*)__xlx_apatb_param_m_axis_V_data_V)->size() - __xlx_apatb_param_m_axis_stream_buf_size;
{
  while (!((hls::stream<__cosim_s40__>*)__xlx_apatb_param_m_axis_V_data_V)->empty())
    __xlx_apatb_param_m_axis_V_data_V_stream_buf.push_back(((hls::stream<__cosim_s40__>*)__xlx_apatb_param_m_axis_V_data_V)->read());
  for (int i = 0; i < __xlx_apatb_param_m_axis_V_data_V_stream_buf.size(); ++i)
    ((hls::stream<__cosim_s40__>*)__xlx_apatb_param_m_axis_V_data_V)->write(__xlx_apatb_param_m_axis_V_data_V_stream_buf[i]);
  }
{
  while (!((hls::stream<long long>*)__xlx_apatb_param_m_axis_V_keep_V)->empty())
    __xlx_apatb_param_m_axis_V_keep_V_stream_buf.push_back(((hls::stream<long long>*)__xlx_apatb_param_m_axis_V_keep_V)->read());
  for (int i = 0; i < __xlx_apatb_param_m_axis_V_keep_V_stream_buf.size(); ++i)
    ((hls::stream<long long>*)__xlx_apatb_param_m_axis_V_keep_V)->write(__xlx_apatb_param_m_axis_V_keep_V_stream_buf[i]);
  }
{
  while (!((hls::stream<long long>*)__xlx_apatb_param_m_axis_V_strb_V)->empty())
    __xlx_apatb_param_m_axis_V_strb_V_stream_buf.push_back(((hls::stream<long long>*)__xlx_apatb_param_m_axis_V_strb_V)->read());
  for (int i = 0; i < __xlx_apatb_param_m_axis_V_strb_V_stream_buf.size(); ++i)
    ((hls::stream<long long>*)__xlx_apatb_param_m_axis_V_strb_V)->write(__xlx_apatb_param_m_axis_V_strb_V_stream_buf[i]);
  }
{
...
{
sc_bv<512> __xlx_tmp_lv;
__xlx_tmp_lv.range(63,0) = ((long long*)&__xlx_apatb_param_m_axis_V_data_V_stream_buf[__xlx_apatb_param_m_axis_stream_buf_size+j])[0*8+0];
__xlx_tmp_lv.range(127,64) = ((long long*)&__xlx_apatb_param_m_axis_V_data_V_stream_buf[__xlx_apatb_param_m_axis_stream_buf_size+j])[0*8+1];
__xlx_tmp_lv.range(191,128) = ((long long*)&__xlx_apatb_param_m_axis_V_data_V_stream_buf[__xlx_apatb_param_m_axis_stream_buf_size+j])[0*8+2];
__xlx_tmp_lv.range(255,192) = ((long long*)&__xlx_apatb_param_m_axis_V_data_V_stream_buf[__xlx_apatb_param_m_axis_stream_buf_size+j])[0*8+3];
__xlx_tmp_lv.range(319,256) = ((long long*)&__xlx_apatb_param_m_axis_V_data_V_stream_buf[__xlx_apatb_param_m_axis_stream_buf_size+j])[0*8+4];
__xlx_tmp_lv.range(383,320) = ((long long*)&__xlx_apatb_param_m_axis_V_data_V_stream_buf[__xlx_apatb_param_m_axis_stream_buf_size+j])[0*8+5];
__xlx_tmp_lv.range(447,384) = ((long long*)&__xlx_apatb_param_m_axis_V_data_V_stream_buf[__xlx_apatb_param_m_axis_stream_buf_size+j])[0*8+6];
__xlx_tmp_lv.range(511,448) = ((long long*)&__xlx_apatb_param_m_axis_V_data_V_stream_buf[__xlx_apatb_param_m_axis_stream_buf_size+j])[0*8+7];
__xlx_tmp_0_lv = __xlx_tmp_lv;
}
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_0_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVOUT_m_axis_V_data_V, __xlx_sprintf_buffer.data());
sc_bv<64> __xlx_tmp_1_lv = ((long long*)&__xlx_apatb_param_m_axis_V_keep_V_stream_buf[__xlx_apatb_param_m_axis_stream_buf_size+j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_1_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVOUT_m_axis_V_keep_V, __xlx_sprintf_buffer.data());
sc_bv<64> __xlx_tmp_2_lv = ((long long*)&__xlx_apatb_param_m_axis_V_strb_V_stream_buf[__xlx_apatb_param_m_axis_stream_buf_size+j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_2_lv.to_string(SC_HEX).c_str());
...
long __xlx_apatb_param_m_axis_arp_lookup_reply_stream_buf_final_size = ((hls::stream<long long>*)__xlx_apatb_param_m_axis_arp_lookup_reply)->size() - __xlx_apatb_param_m_axis_arp_lookup_reply_stream_buf_size;
{
  while (!((hls::stream<long long>*)__xlx_apatb_param_m_axis_arp_lookup_reply)->empty())
    __xlx_apatb_param_m_axis_arp_lookup_reply_stream_buf.push_back(((hls::stream<long long>*)__xlx_apatb_param_m_axis_arp_lookup_reply)->read());
  for (int i = 0; i < __xlx_apatb_param_m_axis_arp_lookup_reply_stream_buf.size(); ++i)
    ((hls::stream<long long>*)__xlx_apatb_param_m_axis_arp_lookup_reply)->write(__xlx_apatb_param_m_axis_arp_lookup_reply_stream_buf[i]);
  }
...
sc_bv<56> __xlx_tmp_lv = ((long long*)&__xlx_apatb_param_m_axis_arp_lookup_reply_stream_buf[__xlx_apatb_param_m_axis_arp_lookup_reply_stream_buf_size+j])[0];
aesl_fh.write(AUTOTB_TVOUT_m_axis_arp_lookup_reply, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
...
long __xlx_apatb_param_m_axis_host_arp_lookup_reply_stream_buf_final_size = ((hls::stream<long long>*)__xlx_apatb_param_m_axis_host_arp_lookup_reply)->size() - __xlx_apatb_param_m_axis_host_arp_lookup_reply_stream_buf_size;
{
  while (!((hls::stream<long long>*)__xlx_apatb_param_m_axis_host_arp_lookup_reply)->empty())
    __xlx_apatb_param_m_axis_host_arp_lookup_reply_stream_buf.push_back(((hls::stream<long long>*)__xlx_apatb_param_m_axis_host_arp_lookup_reply)->read());
  for (int i = 0; i < __xlx_apatb_param_m_axis_host_arp_lookup_reply_stream_buf.size(); ++i)
    ((hls::stream<long long>*)__xlx_apatb_param_m_axis_host_arp_lookup_reply)->write(__xlx_apatb_param_m_axis_host_arp_lookup_reply_stream_buf[i]);
  }
...
sc_bv<56> __xlx_tmp_lv = ((long long*)&__xlx_apatb_param_m_axis_host_arp_lookup_reply_stream_buf[__xlx_apatb_param_m_axis_host_arp_lookup_reply_stream_buf_size+j])[0];
aesl_fh.write(AUTOTB_TVOUT_m_axis_host_arp_lookup_reply, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
...
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_regRequestCount);
aesl_fh.write(AUTOTB_TVOUT_regRequestCount, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.regRequestCount_depth);
...
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_regReplyCount);
aesl_fh.write(AUTOTB_TVOUT_regReplyCount, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.regReplyCount_depth);
