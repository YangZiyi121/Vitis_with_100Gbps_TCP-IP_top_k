...
# FIFO definition: 
set ID 49
set FifoName arp_server_subnet_top_fifo_w1024_d2_S
...
# FIFO definition: 
set ID 52
set FifoName arp_server_subnet_top_fifo_w128_d4_S
...
# FIFO definition: 
set ID 53
set FifoName arp_server_subnet_top_fifo_w81_d4_S
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_arp_lookup_request_TDATA { I 32 vector } s_axis_arp_lookup_request_TVALID { I 1 bit } s_axis_arp_lookup_request_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_host_arp_lookup_request_TDATA { I 32 vector } s_axis_host_arp_lookup_request_TVALID { I 1 bit } s_axis_host_arp_lookup_request_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_arp_lookup_reply_TDATA { O 56 vector } m_axis_arp_lookup_reply_TVALID { O 1 bit } m_axis_arp_lookup_reply_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_host_arp_lookup_reply_TDATA { O 56 vector } m_axis_host_arp_lookup_reply_TVALID { O 1 bit } m_axis_host_arp_lookup_reply_TREADY { I 1 bit } } \
} "
} else {
