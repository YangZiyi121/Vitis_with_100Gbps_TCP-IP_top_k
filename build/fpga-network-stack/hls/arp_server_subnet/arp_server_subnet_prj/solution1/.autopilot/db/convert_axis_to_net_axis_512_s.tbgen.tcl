...
set C_modelArgList {
	...
	{ arpDataIn_internal int 1024 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_V_data_V", "interface" : "axis", "bitwidth" : 512, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "arpDataIn_internal", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ arpDataIn_internal_din sc_out sc_lv 1024 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "arpDataIn_internal_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "arpDataIn_internal", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	arpDataIn_internal { ap_fifo {  { arpDataIn_internal_din fifo_data 1 1024 }  { arpDataIn_internal_full_n fifo_status 0 1 }  { arpDataIn_internal_write fifo_update 1 1 } } }
}
