...
set C_modelArgList {
	...
	{ arpDataOut_internal int 1024 regular {fifo 0 volatile } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "m_axis_V_data_V", "interface" : "axis", "bitwidth" : 512, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "arpDataOut_internal", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ arpDataOut_internal_dout sc_in sc_lv 1024 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "arpDataOut_internal_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "arpDataOut_internal", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	...
	arpDataOut_internal { ap_fifo {  { arpDataOut_internal_dout fifo_data 0 1024 }  { arpDataOut_internal_empty_n fifo_status 0 1 }  { arpDataOut_internal_read fifo_update 1 1 } } }
}
