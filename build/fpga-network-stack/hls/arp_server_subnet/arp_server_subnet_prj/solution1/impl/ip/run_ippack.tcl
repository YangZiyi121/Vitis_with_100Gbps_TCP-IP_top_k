...
set solution_dir "/home/yangz0e/Desktop/Vitis_with_100Gbps_TCP-IP_top_k/build/fpga-network-stack/hls/arp_server_subnet/arp_server_subnet_prj/solution1"
set debug_dir "/home/yangz0e/Desktop/Vitis_with_100Gbps_TCP-IP_top_k/build/fpga-network-stack/hls/arp_server_subnet/arp_server_subnet_prj/solution1/.debug"
...
arp_server_subnet_top_fifo_w1024_d2_S
arp_server_subnet_top_fifo_w1024_d2_S
arp_server_subnet_top_fifo_w32_d2_S
arp_server_subnet_top_fifo_w128_d4_S
arp_server_subnet_top_fifo_w81_d4_S
...
set Interfaces {
    ap_clk {
        ...
        buses "s_axis s_axis_arp_lookup_request s_axis_host_arp_lookup_request m_axis m_axis_arp_lookup_reply m_axis_host_arp_lookup_reply"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    s_axis_arp_lookup_request {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_arp_lookup_request"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    s_axis_host_arp_lookup_request {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_host_arp_lookup_request"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    m_axis_arp_lookup_reply {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_arp_lookup_reply"
        has_tready "1"
        ports {
            TDATA 56
        }
    ...
    m_axis_host_arp_lookup_reply {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_host_arp_lookup_reply"
        has_tready "1"
        ports {
            TDATA 56
        }
