...
module arp_server_subnet_top_convert_axis_to_net_axis_512_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_ready;
input   s_axis_TVALID;
output  [1023:0] arpDataIn_internal_din;
...
assign arpDataIn_internal_din = tmp_10_i_fu_79_p4;

assign s_axis_TREADY = regslice_both_s_axis_V_data_V_U_ack_in;

assign tmp_10_i_fu_79_p4 = {{{tmp_last_V_reg_105}, {tmp_keep_V_reg_100}}, {tmp_data_V_reg_95}};

assign tmp_nbreadreq_fu_34_p6 = s_axis_TVALID_int_regslice;

endmodule //arp_server_subnet_top_convert_axis_to_net_axis_512_s
