    ...
    function [680:0] proc_path(input [PROC_NUM - 1:0] dl_vec);
        ...
        begin
            ...
            case (index)
                0 : begin
                    proc_path = "ip_handler_top_ip_handler_top.entry_proc_U0";
                end
                1 : begin
                ...
                3 : begin
                    proc_path = "ip_handler_top_ip_handler_top.convert_net_axis_to_axis_512_1_U0";
                end
                4 : begin
                    proc_path = "ip_handler_top_ip_handler_top.convert_net_axis_to_axis_512_2_U0";
                end
                5 : begin
                    proc_path = "ip_handler_top_ip_handler_top.convert_net_axis_to_axis_512_3_U0";
                end
                6 : begin
                    proc_path = "ip_handler_top_ip_handler_top.convert_net_axis_to_axis_512_4_U0";
                end
                7 : begin
                    proc_path = "ip_handler_top_ip_handler_top.convert_net_axis_to_axis_512_5_U0";
                end
                8 : begin
                    proc_path = "ip_handler_top_ip_handler_top.convert_net_axis_to_axis_512_6_U0";
                end
                9 : begin
        ...
        begin
            ...
            case (index1)
                ...
                2 : begin
                    case(index2)
                    10: begin
                        if (~convert_net_axis_to_axis_512_U0.m_axis_arp_internal_blk_n) begin
                ...
                3 : begin
                    case(index2)
                    19: begin
                        if (~convert_net_axis_to_axis_512_1_U0.m_axis_icmpv6_internal_blk_n) begin
                ...
                4 : begin
                    case(index2)
                    19: begin
                        if (~convert_net_axis_to_axis_512_2_U0.m_axis_ipv6udp_internal_blk_n) begin
                ...
                5 : begin
                    case(index2)
                    18: begin
                        if (~convert_net_axis_to_axis_512_3_U0.m_axis_icmp_internal_blk_n) begin
                ...
                6 : begin
                    case(index2)
                    20: begin
                        if (~convert_net_axis_to_axis_512_4_U0.m_axis_udp_internal_blk_n) begin
                ...
                7 : begin
                    case(index2)
                    18: begin
                        if (~convert_net_axis_to_axis_512_5_U0.m_axis_tcp_internal_blk_n) begin
                ...
                8 : begin
                    case(index2)
                    20: begin
                        if (~convert_net_axis_to_axis_512_6_U0.m_axis_roce_internal_blk_n) begin
                ...
                10 : begin
                    ...
                    2: begin
                        if (~route_by_eth_protocol_512_U0.m_axis_arp_internal_blk_n) begin
                            if (~m_axis_arp_internal_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'ip_handler_top_ip_handler_top.m_axis_arp_internal_U' written by process 'ip_handler_top_ip_handler_top.convert_net_axis_to_axis_512_U0'");
                                $fdisplay(fp, "Dependence_Channel_path ip_handler_top_ip_handler_top.m_axis_arp_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~m_axis_arp_internal_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'ip_handler_top_ip_handler_top.m_axis_arp_internal_U' read by process 'ip_handler_top_ip_handler_top.convert_net_axis_to_axis_512_U0'");
                                $fdisplay(fp, "Dependence_Channel_path ip_handler_top_ip_handler_top.m_axis_arp_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                ...
                13 : begin
                    ...
                    0: begin
                        if (~extract_ip_meta_512_U0.myIpAddress_blk_n) begin
                            if (~myIpAddress_c_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'ip_handler_top_ip_handler_top.myIpAddress_c_U' written by process 'ip_handler_top_ip_handler_top.entry_proc_U0'");
                                $fdisplay(fp, "Dependence_Channel_path ip_handler_top_ip_handler_top.myIpAddress_c_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~myIpAddress_c_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'ip_handler_top_ip_handler_top.myIpAddress_c_U' read by process 'ip_handler_top_ip_handler_top.entry_proc_U0'");
                                $fdisplay(fp, "Dependence_Channel_path ip_handler_top_ip_handler_top.myIpAddress_c_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                ...
                18 : begin
                    ...
                    5: begin
                        if (~detect_ipv4_protocol_512_U0.m_axis_icmp_internal_blk_n) begin
                            if (~m_axis_icmp_internal_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'ip_handler_top_ip_handler_top.m_axis_icmp_internal_U' written by process 'ip_handler_top_ip_handler_top.convert_net_axis_to_axis_512_3_U0'");
                                $fdisplay(fp, "Dependence_Channel_path ip_handler_top_ip_handler_top.m_axis_icmp_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~m_axis_icmp_internal_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'ip_handler_top_ip_handler_top.m_axis_icmp_internal_U' read by process 'ip_handler_top_ip_handler_top.convert_net_axis_to_axis_512_3_U0'");
                                $fdisplay(fp, "Dependence_Channel_path ip_handler_top_ip_handler_top.m_axis_icmp_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                    ...
                    7: begin
                        if (~detect_ipv4_protocol_512_U0.m_axis_tcp_internal_blk_n) begin
                            if (~m_axis_tcp_internal_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'ip_handler_top_ip_handler_top.m_axis_tcp_internal_U' written by process 'ip_handler_top_ip_handler_top.convert_net_axis_to_axis_512_5_U0'");
                                $fdisplay(fp, "Dependence_Channel_path ip_handler_top_ip_handler_top.m_axis_tcp_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~m_axis_tcp_internal_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'ip_handler_top_ip_handler_top.m_axis_tcp_internal_U' read by process 'ip_handler_top_ip_handler_top.convert_net_axis_to_axis_512_5_U0'");
                                $fdisplay(fp, "Dependence_Channel_path ip_handler_top_ip_handler_top.m_axis_tcp_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                ...
                19 : begin
                    ...
                    3: begin
                        if (~detect_ipv6_protocol_512_U0.m_axis_icmpv6_internal_blk_n) begin
                            if (~m_axis_icmpv6_internal_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'ip_handler_top_ip_handler_top.m_axis_icmpv6_internal_U' written by process 'ip_handler_top_ip_handler_top.convert_net_axis_to_axis_512_1_U0'");
                                $fdisplay(fp, "Dependence_Channel_path ip_handler_top_ip_handler_top.m_axis_icmpv6_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~m_axis_icmpv6_internal_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'ip_handler_top_ip_handler_top.m_axis_icmpv6_internal_U' read by process 'ip_handler_top_ip_handler_top.convert_net_axis_to_axis_512_1_U0'");
                                $fdisplay(fp, "Dependence_Channel_path ip_handler_top_ip_handler_top.m_axis_icmpv6_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                    ...
                    4: begin
                        if (~detect_ipv6_protocol_512_U0.m_axis_ipv6udp_internal_blk_n) begin
                            if (~m_axis_ipv6udp_internal_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'ip_handler_top_ip_handler_top.m_axis_ipv6udp_internal_U' written by process 'ip_handler_top_ip_handler_top.convert_net_axis_to_axis_512_2_U0'");
                                $fdisplay(fp, "Dependence_Channel_path ip_handler_top_ip_handler_top.m_axis_ipv6udp_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~m_axis_ipv6udp_internal_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'ip_handler_top_ip_handler_top.m_axis_ipv6udp_internal_U' read by process 'ip_handler_top_ip_handler_top.convert_net_axis_to_axis_512_2_U0'");
                                $fdisplay(fp, "Dependence_Channel_path ip_handler_top_ip_handler_top.m_axis_ipv6udp_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                ...
                20 : begin
                    ...
                    6: begin
                        if (~ip_handler_duplicate_stream_net_axis_512_U0.m_axis_udp_internal_blk_n) begin
                            if (~m_axis_udp_internal_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'ip_handler_top_ip_handler_top.m_axis_udp_internal_U' written by process 'ip_handler_top_ip_handler_top.convert_net_axis_to_axis_512_4_U0'");
                                $fdisplay(fp, "Dependence_Channel_path ip_handler_top_ip_handler_top.m_axis_udp_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~m_axis_udp_internal_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'ip_handler_top_ip_handler_top.m_axis_udp_internal_U' read by process 'ip_handler_top_ip_handler_top.convert_net_axis_to_axis_512_4_U0'");
                                $fdisplay(fp, "Dependence_Channel_path ip_handler_top_ip_handler_top.m_axis_udp_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
                    ...
                    8: begin
                        if (~ip_handler_duplicate_stream_net_axis_512_U0.m_axis_roce_internal_blk_n) begin
                            if (~m_axis_roce_internal_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'ip_handler_top_ip_handler_top.m_axis_roce_internal_U' written by process 'ip_handler_top_ip_handler_top.convert_net_axis_to_axis_512_6_U0'");
                                $fdisplay(fp, "Dependence_Channel_path ip_handler_top_ip_handler_top.m_axis_roce_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~m_axis_roce_internal_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'ip_handler_top_ip_handler_top.m_axis_roce_internal_U' read by process 'ip_handler_top_ip_handler_top.convert_net_axis_to_axis_512_6_U0'");
                                $fdisplay(fp, "Dependence_Channel_path ip_handler_top_ip_handler_top.m_axis_roce_internal_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
