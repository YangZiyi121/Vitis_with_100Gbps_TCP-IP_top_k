...
attribute shreg_extract : string;
    ...
    signal trunc_ln674_reg_291 : STD_LOGIC_VECTOR (111 downto 0);
    signal p_Result_4_i_reg_296 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal p_Result_5_i_fu_186_p4 : STD_LOGIC_VECTOR (49 downto 0);
    signal grp_fu_125_p4 : STD_LOGIC_VECTOR (49 downto 0);
    signal grp_fu_116_p4 : STD_LOGIC_VECTOR (399 downto 0);
    signal tmp_12_i_fu_233_p6 : STD_LOGIC_VECTOR (576 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_i_nbreadreq_fu_74_p3 = ap_const_lv1_1) and (fsmState = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (rs_firstWord_load_load_fu_168_p1 = ap_const_lv1_0))) then
                p_Result_4_i_reg_296 <= ipv6ShiftFifo_dout(525 downto 512);
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, ipv6ShiftFifo_empty_n, ap_predicate_op18_read_state1, ap_done_reg, ipv6DataFifo_full_n, fsmState_load_reg_266, ap_predicate_op46_write_state2)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((fsmState_load_reg_266 = ap_const_lv1_1) and (ipv6DataFifo_full_n = ap_const_logic_0)) or ((ap_predicate_op46_write_state2 = ap_const_boolean_1) and (ipv6DataFifo_full_n = ap_const_logic_0)))) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((ap_predicate_op18_read_state1 = ap_const_boolean_1) and (ipv6ShiftFifo_empty_n = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, ipv6ShiftFifo_empty_n, ap_predicate_op18_read_state1, ap_done_reg, ipv6DataFifo_full_n, fsmState_load_reg_266, ap_predicate_op46_write_state2)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((fsmState_load_reg_266 = ap_const_lv1_1) and (ipv6DataFifo_full_n = ap_const_logic_0)) or ((ap_predicate_op46_write_state2 = ap_const_boolean_1) and (ipv6DataFifo_full_n = ap_const_logic_0)))) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((ap_predicate_op18_read_state1 = ap_const_boolean_1) and (ipv6ShiftFifo_empty_n = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, ipv6ShiftFifo_empty_n, ap_predicate_op18_read_state1, ap_done_reg, ipv6DataFifo_full_n, fsmState_load_reg_266, ap_predicate_op46_write_state2)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((fsmState_load_reg_266 = ap_const_lv1_1) and (ipv6DataFifo_full_n = ap_const_logic_0)) or ((ap_predicate_op46_write_state2 = ap_const_boolean_1) and (ipv6DataFifo_full_n = ap_const_logic_0)))) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((ap_predicate_op18_read_state1 = ap_const_boolean_1) and (ipv6ShiftFifo_empty_n = ap_const_logic_0)))));
    end process;


    ap_block_state1_pp0_stage0_iter0_assign_proc : process(ipv6ShiftFifo_empty_n, ap_predicate_op18_read_state1, ap_done_reg)
    begin
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(ipv6DataFifo_full_n, fsmState_load_reg_266, ap_predicate_op46_write_state2)
    begin
                ap_block_state2_pp0_stage0_iter1 <= (((fsmState_load_reg_266 = ap_const_lv1_1) and (ipv6DataFifo_full_n = ap_const_logic_0)) or ((ap_predicate_op46_write_state2 = ap_const_boolean_1) and (ipv6DataFifo_full_n = ap_const_logic_0)));
    end process;
    ...
    currWord_data_V_fu_146_p1 <= ipv6ShiftFifo_dout(512 - 1 downto 0);
    currWord_last_V_fu_160_p3 <= ipv6ShiftFifo_dout(576 downto 576);
    fsmState_load_load_fu_134_p1 <= fsmState;
    grp_fu_116_p4 <= p_Val2_s_reg_270(511 downto 112);
    grp_fu_125_p4 <= p_Val2_1_reg_275(63 downto 14);

    ipv6DataFifo_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ipv6DataFifo_full_n, fsmState_load_reg_266, ap_predicate_op46_write_state2, ap_block_pp0_stage0)
    begin
    ...
    ipv6DataFifo_din_assign_proc : process(fsmState_load_reg_266, ap_predicate_op46_write_state2, zext_ln173_1_fu_244_p1, zext_ln173_fu_261_p1, ap_condition_162)
    begin
    ...
    ipv6DataFifo_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, fsmState_load_reg_266, ap_predicate_op46_write_state2, ap_block_pp0_stage0_11001)
    begin
    ...
    ipv6ShiftFifo_blk_n_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, ipv6ShiftFifo_empty_n, ap_predicate_op18_read_state1, ap_done_reg, ap_block_pp0_stage0)
    begin
    ...
    or_ln_fu_249_p5 <= (((ap_const_lv15_4000 & grp_fu_125_p4) & ap_const_lv112_0) & grp_fu_116_p4);
    p_Result_5_i_fu_186_p4 <= ipv6ShiftFifo_dout(575 downto 526);
    rs_firstWord_load_load_fu_168_p1 <= rs_firstWord;
    sendWord_last_V_fu_196_p2 <= "1" when (p_Result_5_i_fu_186_p4 = ap_const_lv50_0) else "0";
    tmp_12_i_fu_233_p6 <= ((((sendWord_last_V_reg_301 & p_Result_4_i_reg_296) & grp_fu_125_p4) & trunc_ln674_reg_291) & grp_fu_116_p4);
    tmp_i_nbreadreq_fu_74_p3 <= (0=>(ipv6ShiftFifo_empty_n), others=>'-');
    trunc_ln674_fu_172_p1 <= ipv6ShiftFifo_dout(112 - 1 downto 0);
    zext_ln173_1_fu_244_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_12_i_fu_233_p6),1024));
