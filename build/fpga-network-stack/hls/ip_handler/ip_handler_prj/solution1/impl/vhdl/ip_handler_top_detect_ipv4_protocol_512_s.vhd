...
attribute shreg_extract : string;
    ...
    signal tmp_1_i_nbreadreq_fu_66_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_predicate_op34_read_state1 : BOOLEAN;
    signal ap_predicate_op36_read_state1 : BOOLEAN;
    signal tmp_i_59_nbreadreq_fu_86_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_predicate_op44_read_state1 : BOOLEAN;
    signal ap_done_reg : STD_LOGIC := '0';
    signal ap_block_state1_pp0_stage0_iter0 : BOOLEAN;
    signal dip_state_load_reg_160 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_i_59_reg_173 : STD_LOGIC_VECTOR (0 downto 0);
    signal dip_ipProtocol_V_load_reg_186 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal ipDataCutFifo_read_reg_177 : STD_LOGIC_VECTOR (576 downto 0);
    signal tmp_67_read_fu_80_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_last_V_fu_137_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal p_07_fu_155_p1 : STD_LOGIC_VECTOR (1023 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_1_i_nbreadreq_fu_66_p3 = ap_const_lv1_1) and (tmp_i_nbreadreq_fu_58_p3 = ap_const_lv1_1) and (dip_state = ap_const_lv1_0) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_i_59_nbreadreq_fu_86_p3 = ap_const_lv1_1) and (dip_state = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
    ...
    begin
                ap_block_pp0_stage0_01001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((ap_predicate_op44_read_state1 = ap_const_boolean_1) and (ipDataCutFifo_empty_n = ap_const_logic_0)) or ((ap_predicate_op36_read_state1 = ap_const_boolean_1) and (ipv4ValidFifo_empty_n = ap_const_logic_0)) or ((ap_predicate_op34_read_state1 = ap_const_boolean_1) and (ipv4ProtocolFifo_empty_n = ap_const_logic_0)))) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((udpDataFifo_full_n = ap_const_logic_0) and (ap_predicate_op56_write_state2 = ap_const_boolean_1)) or ((ap_predicate_op54_write_state2 = ap_const_boolean_1) and (m_axis_tcp_internal_full_n = ap_const_logic_0)) or ((ap_predicate_op58_write_state2 = ap_const_boolean_1) and (m_axis_icmp_internal_full_n = ap_const_logic_0)))));
    end process;
    ...
    ap_condition_167_assign_proc : process(tmp_i_nbreadreq_fu_58_p3, tmp_1_i_nbreadreq_fu_66_p3, dip_state, tmp_67_read_fu_80_p2)
    begin
                ap_condition_167 <= ((tmp_1_i_nbreadreq_fu_66_p3 = ap_const_lv1_1) and (tmp_i_nbreadreq_fu_58_p3 = ap_const_lv1_1) and (dip_state = ap_const_lv1_0) and (tmp_67_read_fu_80_p2 = ap_const_lv1_1));
    end process;


    ap_condition_171_assign_proc : process(tmp_i_59_nbreadreq_fu_86_p3, dip_state, tmp_last_V_fu_137_p3)
    begin
                ap_condition_171 <= ((tmp_i_59_nbreadreq_fu_86_p3 = ap_const_lv1_1) and (dip_state = ap_const_lv1_1) and (tmp_last_V_fu_137_p3 = ap_const_lv1_1));
    end process;
    ...
    ap_predicate_op34_read_state1_assign_proc : process(tmp_i_nbreadreq_fu_58_p3, tmp_1_i_nbreadreq_fu_66_p3, dip_state)
    begin
                ap_predicate_op34_read_state1 <= ((tmp_1_i_nbreadreq_fu_66_p3 = ap_const_lv1_1) and (tmp_i_nbreadreq_fu_58_p3 = ap_const_lv1_1) and (dip_state = ap_const_lv1_0));
    end process;


    ap_predicate_op36_read_state1_assign_proc : process(tmp_i_nbreadreq_fu_58_p3, tmp_1_i_nbreadreq_fu_66_p3, dip_state)
    begin
                ap_predicate_op36_read_state1 <= ((tmp_1_i_nbreadreq_fu_66_p3 = ap_const_lv1_1) and (tmp_i_nbreadreq_fu_58_p3 = ap_const_lv1_1) and (dip_state = ap_const_lv1_0));
    end process;


    ap_predicate_op44_read_state1_assign_proc : process(tmp_i_59_nbreadreq_fu_86_p3, dip_state)
    begin
                ap_predicate_op44_read_state1 <= ((tmp_i_59_nbreadreq_fu_86_p3 = ap_const_lv1_1) and (dip_state = ap_const_lv1_1));
    end process;


    ap_predicate_op54_write_state2_assign_proc : process(dip_state_load_reg_160, tmp_i_59_reg_173, dip_ipProtocol_V_load_reg_186)
    begin
                ap_predicate_op54_write_state2 <= ((dip_ipProtocol_V_load_reg_186 = ap_const_lv8_6) and (tmp_i_59_reg_173 = ap_const_lv1_1) and (dip_state_load_reg_160 = ap_const_lv1_1));
    end process;


    ap_predicate_op56_write_state2_assign_proc : process(dip_state_load_reg_160, tmp_i_59_reg_173, dip_ipProtocol_V_load_reg_186)
    begin
                ap_predicate_op56_write_state2 <= ((dip_ipProtocol_V_load_reg_186 = ap_const_lv8_11) and (tmp_i_59_reg_173 = ap_const_lv1_1) and (dip_state_load_reg_160 = ap_const_lv1_1));
    end process;


    ap_predicate_op58_write_state2_assign_proc : process(dip_state_load_reg_160, tmp_i_59_reg_173, dip_ipProtocol_V_load_reg_186)
    begin
                ap_predicate_op58_write_state2 <= ((dip_ipProtocol_V_load_reg_186 = ap_const_lv8_1) and (tmp_i_59_reg_173 = ap_const_lv1_1) and (dip_state_load_reg_160 = ap_const_lv1_1));
    end process;
    ...
    m_axis_icmp_internal_din <= p_07_fu_155_p1;
    ...
    m_axis_tcp_internal_din <= p_07_fu_155_p1;
    ...
    p_07_fu_155_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ipDataCutFifo_read_reg_177),1024));
    tmp_1_i_nbreadreq_fu_66_p3 <= (0=>(ipv4ValidFifo_empty_n), others=>'-');
    tmp_67_read_fu_80_p2 <= ipv4ValidFifo_dout;
    tmp_i_59_nbreadreq_fu_86_p3 <= (0=>(ipDataCutFifo_empty_n), others=>'-');
    tmp_i_nbreadreq_fu_58_p3 <= (0=>(ipv4ProtocolFifo_empty_n), others=>'-');
    tmp_last_V_fu_137_p3 <= ipDataCutFifo_dout(576 downto 576);
    ...
    udpDataFifo_din <= ipDataCutFifo_read_reg_177;
