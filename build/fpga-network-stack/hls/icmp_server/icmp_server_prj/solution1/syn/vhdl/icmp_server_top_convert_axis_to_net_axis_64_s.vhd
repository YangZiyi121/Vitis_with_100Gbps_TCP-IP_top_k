...
attribute shreg_extract : string;
    ...
    signal tmp_32_i_fu_79_p4 : STD_LOGIC_VECTOR (72 downto 0);
...
begin
    regslice_both_s_axis_V_data_V_U : component icmp_server_top_regslice_both
    generic map (
        DataWidth => 64)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_V_keep_V_U : component icmp_server_top_regslice_both
    generic map (
        DataWidth => 8)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_V_strb_V_U : component icmp_server_top_regslice_both
    generic map (
        DataWidth => 8)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_V_last_V_U : component icmp_server_top_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_nbreadreq_fu_34_p6 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_data_V_reg_95 <= s_axis_TDATA_int_regslice;
                tmp_keep_V_reg_100 <= s_axis_TKEEP_int_regslice;
                tmp_last_V_reg_105 <= s_axis_TLAST_int_regslice;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_34_p6, ap_done_reg, dataIn_internal_full_n, tmp_reg_91, s_axis_TVALID_int_regslice)
    begin
    ...
    ap_block_pp0_stage0_11001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_34_p6, ap_done_reg, dataIn_internal_full_n, tmp_reg_91, s_axis_TVALID_int_regslice)
    begin
    ...
    ap_block_pp0_stage0_subdone_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_34_p6, ap_done_reg, dataIn_internal_full_n, tmp_reg_91, s_axis_TVALID_int_regslice)
    begin
    ...
    ap_block_state1_pp0_stage0_iter0_assign_proc : process(tmp_nbreadreq_fu_34_p6, ap_done_reg, s_axis_TVALID_int_regslice)
    begin
    ...
    dataIn_internal_din <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_32_i_fu_79_p4),128));
    ...
    s_axis_TDATA_blk_n_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, tmp_nbreadreq_fu_34_p6, ap_done_reg, ap_block_pp0_stage0, s_axis_TVALID_int_regslice)
    begin
    ...
    tmp_32_i_fu_79_p4 <= ((tmp_last_V_reg_105 & tmp_keep_V_reg_100) & tmp_data_V_reg_95);
