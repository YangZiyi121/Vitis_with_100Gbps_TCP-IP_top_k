...
static bool RTLOutputCheckAndReplacement(std::string &AESL_token, std::string PortName) {
  ...
  return err;}
extern "C" void icmp_server_top_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);

extern "C" void apatb_icmp_server_top_hw(volatile void * __xlx_apatb_param_s_axis_V_data_V, volatile void * __xlx_apatb_param_s_axis_V_keep_V, volatile void * __xlx_apatb_param_s_axis_V_strb_V, volatile void * __xlx_apatb_param_s_axis_V_last_V, volatile void * __xlx_apatb_param_udpIn_V_data_V, volatile void * __xlx_apatb_param_udpIn_V_keep_V, volatile void * __xlx_apatb_param_udpIn_V_strb_V, volatile void * __xlx_apatb_param_udpIn_V_last_V, volatile void * __xlx_apatb_param_ttlIn_V_data_V, volatile void * __xlx_apatb_param_ttlIn_V_keep_V, volatile void * __xlx_apatb_param_ttlIn_V_strb_V, volatile void * __xlx_apatb_param_ttlIn_V_last_V, volatile void * __xlx_apatb_param_m_axis_V_data_V, volatile void * __xlx_apatb_param_m_axis_V_keep_V, volatile void * __xlx_apatb_param_m_axis_V_strb_V, volatile void * __xlx_apatb_param_m_axis_V_last_V) {
...
long __xlx_apatb_param_s_axis_stream_buf_final_size;
{
  ...
  for (long i = 0; i < __xlx_apatb_param_s_axis_stream_buf_final_size; ++i) {
((hls::stream<long long>*)__xlx_apatb_param_s_axis_V_data_V)->read();
((hls::stream<char>*)__xlx_apatb_param_s_axis_V_keep_V)->read();
((hls::stream<char>*)__xlx_apatb_param_s_axis_V_strb_V)->read();
((hls::stream<char>*)__xlx_apatb_param_s_axis_V_last_V)->read();
}
long __xlx_apatb_param_udpIn_stream_buf_final_size;
{
  ...
  for (long i = 0; i < __xlx_apatb_param_udpIn_stream_buf_final_size; ++i) {
((hls::stream<long long>*)__xlx_apatb_param_udpIn_V_data_V)->read();
((hls::stream<char>*)__xlx_apatb_param_udpIn_V_keep_V)->read();
((hls::stream<char>*)__xlx_apatb_param_udpIn_V_strb_V)->read();
((hls::stream<char>*)__xlx_apatb_param_udpIn_V_last_V)->read();
}
long __xlx_apatb_param_ttlIn_stream_buf_final_size;
{
  ...
  for (long i = 0; i < __xlx_apatb_param_ttlIn_stream_buf_final_size; ++i) {
((hls::stream<long long>*)__xlx_apatb_param_ttlIn_V_data_V)->read();
((hls::stream<char>*)__xlx_apatb_param_ttlIn_V_keep_V)->read();
((hls::stream<char>*)__xlx_apatb_param_ttlIn_V_strb_V)->read();
((hls::stream<char>*)__xlx_apatb_param_ttlIn_V_last_V)->read();
}
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          while (AESL_token != "[[/transaction]]"){
            ...
            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "m_axis");
...
((long long*)&xlx_stream_elt_data)[0] = m_axis_V_data_V_pc_buffer_Copy[j].to_int64();
((hls::stream<long long>*)__xlx_apatb_param_m_axis_V_data_V)->write(xlx_stream_elt_data);
char xlx_stream_elt_keep;
((char*)&xlx_stream_elt_keep)[0] = m_axis_V_keep_V_pc_buffer_Copy[j].to_int64();
((hls::stream<char>*)__xlx_apatb_param_m_axis_V_keep_V)->write(xlx_stream_elt_keep);
char xlx_stream_elt_strb;
((char*)&xlx_stream_elt_strb)[0] = m_axis_V_strb_V_pc_buffer_Copy[j].to_int64();
((hls::stream<char>*)__xlx_apatb_param_m_axis_V_strb_V)->write(xlx_stream_elt_strb);
char xlx_stream_elt_last;
((char*)&xlx_stream_elt_last)[0] = m_axis_V_last_V_pc_buffer_Copy[j].to_uint64();
((hls::stream<char>*)__xlx_apatb_param_m_axis_V_last_V)->write(xlx_stream_elt_last);
}}
    AESL_transaction_pc++;
    return ;
  }
...
// data
std::vector<long long> __xlx_apatb_param_s_axis_V_data_V_stream_buf;
{
  while (!((hls::stream<long long>*)__xlx_apatb_param_s_axis_V_data_V)->empty())
    __xlx_apatb_param_s_axis_V_data_V_stream_buf.push_back(((hls::stream<long long>*)__xlx_apatb_param_s_axis_V_data_V)->read());
  for (int i = 0; i < __xlx_apatb_param_s_axis_V_data_V_stream_buf.size(); ++i)
    ((hls::stream<long long>*)__xlx_apatb_param_s_axis_V_data_V)->write(__xlx_apatb_param_s_axis_V_data_V_stream_buf[i]);
  }
long __xlx_apatb_param_s_axis_stream_buf_size = ((hls::stream<long long>*)__xlx_apatb_param_s_axis_V_data_V)->size();
// keep
std::vector<char> __xlx_apatb_param_s_axis_V_keep_V_stream_buf;
{
  while (!((hls::stream<char>*)__xlx_apatb_param_s_axis_V_keep_V)->empty())
    __xlx_apatb_param_s_axis_V_keep_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_s_axis_V_keep_V)->read());
  for (int i = 0; i < __xlx_apatb_param_s_axis_V_keep_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_s_axis_V_keep_V)->write(__xlx_apatb_param_s_axis_V_keep_V_stream_buf[i]);
  }
// strb
std::vector<char> __xlx_apatb_param_s_axis_V_strb_V_stream_buf;
{
  while (!((hls::stream<char>*)__xlx_apatb_param_s_axis_V_strb_V)->empty())
    __xlx_apatb_param_s_axis_V_strb_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_s_axis_V_strb_V)->read());
  for (int i = 0; i < __xlx_apatb_param_s_axis_V_strb_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_s_axis_V_strb_V)->write(__xlx_apatb_param_s_axis_V_strb_V_stream_buf[i]);
  }
// user
// last
std::vector<char> __xlx_apatb_param_s_axis_V_last_V_stream_buf;
{
  while (!((hls::stream<char>*)__xlx_apatb_param_s_axis_V_last_V)->empty())
    __xlx_apatb_param_s_axis_V_last_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_s_axis_V_last_V)->read());
  for (int i = 0; i < __xlx_apatb_param_s_axis_V_last_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_s_axis_V_last_V)->write(__xlx_apatb_param_s_axis_V_last_V_stream_buf[i]);
  }
// id
// dest
// data
std::vector<long long> __xlx_apatb_param_udpIn_V_data_V_stream_buf;
{
  while (!((hls::stream<long long>*)__xlx_apatb_param_udpIn_V_data_V)->empty())
    __xlx_apatb_param_udpIn_V_data_V_stream_buf.push_back(((hls::stream<long long>*)__xlx_apatb_param_udpIn_V_data_V)->read());
  for (int i = 0; i < __xlx_apatb_param_udpIn_V_data_V_stream_buf.size(); ++i)
    ((hls::stream<long long>*)__xlx_apatb_param_udpIn_V_data_V)->write(__xlx_apatb_param_udpIn_V_data_V_stream_buf[i]);
  }
long __xlx_apatb_param_udpIn_stream_buf_size = ((hls::stream<long long>*)__xlx_apatb_param_udpIn_V_data_V)->size();
// keep
std::vector<char> __xlx_apatb_param_udpIn_V_keep_V_stream_buf;
{
  while (!((hls::stream<char>*)__xlx_apatb_param_udpIn_V_keep_V)->empty())
    __xlx_apatb_param_udpIn_V_keep_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_udpIn_V_keep_V)->read());
  for (int i = 0; i < __xlx_apatb_param_udpIn_V_keep_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_udpIn_V_keep_V)->write(__xlx_apatb_param_udpIn_V_keep_V_stream_buf[i]);
  }
// strb
std::vector<char> __xlx_apatb_param_udpIn_V_strb_V_stream_buf;
{
  while (!((hls::stream<char>*)__xlx_apatb_param_udpIn_V_strb_V)->empty())
    __xlx_apatb_param_udpIn_V_strb_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_udpIn_V_strb_V)->read());
  for (int i = 0; i < __xlx_apatb_param_udpIn_V_strb_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_udpIn_V_strb_V)->write(__xlx_apatb_param_udpIn_V_strb_V_stream_buf[i]);
  }
// user
// last
std::vector<char> __xlx_apatb_param_udpIn_V_last_V_stream_buf;
{
  while (!((hls::stream<char>*)__xlx_apatb_param_udpIn_V_last_V)->empty())
    __xlx_apatb_param_udpIn_V_last_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_udpIn_V_last_V)->read());
  for (int i = 0; i < __xlx_apatb_param_udpIn_V_last_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_udpIn_V_last_V)->write(__xlx_apatb_param_udpIn_V_last_V_stream_buf[i]);
  }
// id
// dest
// data
std::vector<long long> __xlx_apatb_param_ttlIn_V_data_V_stream_buf;
{
  while (!((hls::stream<long long>*)__xlx_apatb_param_ttlIn_V_data_V)->empty())
    __xlx_apatb_param_ttlIn_V_data_V_stream_buf.push_back(((hls::stream<long long>*)__xlx_apatb_param_ttlIn_V_data_V)->read());
  for (int i = 0; i < __xlx_apatb_param_ttlIn_V_data_V_stream_buf.size(); ++i)
    ((hls::stream<long long>*)__xlx_apatb_param_ttlIn_V_data_V)->write(__xlx_apatb_param_ttlIn_V_data_V_stream_buf[i]);
  }
long __xlx_apatb_param_ttlIn_stream_buf_size = ((hls::stream<long long>*)__xlx_apatb_param_ttlIn_V_data_V)->size();
// keep
std::vector<char> __xlx_apatb_param_ttlIn_V_keep_V_stream_buf;
{
  while (!((hls::stream<char>*)__xlx_apatb_param_ttlIn_V_keep_V)->empty())
    __xlx_apatb_param_ttlIn_V_keep_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_ttlIn_V_keep_V)->read());
  for (int i = 0; i < __xlx_apatb_param_ttlIn_V_keep_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_ttlIn_V_keep_V)->write(__xlx_apatb_param_ttlIn_V_keep_V_stream_buf[i]);
  }
// strb
std::vector<char> __xlx_apatb_param_ttlIn_V_strb_V_stream_buf;
{
  while (!((hls::stream<char>*)__xlx_apatb_param_ttlIn_V_strb_V)->empty())
    __xlx_apatb_param_ttlIn_V_strb_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_ttlIn_V_strb_V)->read());
  for (int i = 0; i < __xlx_apatb_param_ttlIn_V_strb_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_ttlIn_V_strb_V)->write(__xlx_apatb_param_ttlIn_V_strb_V_stream_buf[i]);
  }
// user
// last
std::vector<char> __xlx_apatb_param_ttlIn_V_last_V_stream_buf;
{
  while (!((hls::stream<char>*)__xlx_apatb_param_ttlIn_V_last_V)->empty())
    __xlx_apatb_param_ttlIn_V_last_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_ttlIn_V_last_V)->read());
  for (int i = 0; i < __xlx_apatb_param_ttlIn_V_last_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_ttlIn_V_last_V)->write(__xlx_apatb_param_ttlIn_V_last_V_stream_buf[i]);
  }
// id
// dest
// data
std::vector<long long> __xlx_apatb_param_m_axis_V_data_V_stream_buf;
long __xlx_apatb_param_m_axis_stream_buf_size = ((hls::stream<long long>*)__xlx_apatb_param_m_axis_V_data_V)->size();
// keep
std::vector<char> __xlx_apatb_param_m_axis_V_keep_V_stream_buf;
// strb
std::vector<char> __xlx_apatb_param_m_axis_V_strb_V_stream_buf;
// user
// last
std::vector<char> __xlx_apatb_param_m_axis_V_last_V_stream_buf;
// id
// dest
CodeState = CALL_C_DUT;
icmp_server_top_hw_stub_wrapper(__xlx_apatb_param_s_axis_V_data_V, __xlx_apatb_param_s_axis_V_keep_V, __xlx_apatb_param_s_axis_V_strb_V, __xlx_apatb_param_s_axis_V_last_V, __xlx_apatb_param_udpIn_V_data_V, __xlx_apatb_param_udpIn_V_keep_V, __xlx_apatb_param_udpIn_V_strb_V, __xlx_apatb_param_udpIn_V_last_V, __xlx_apatb_param_ttlIn_V_data_V, __xlx_apatb_param_ttlIn_V_keep_V, __xlx_apatb_param_ttlIn_V_strb_V, __xlx_apatb_param_ttlIn_V_last_V, __xlx_apatb_param_m_axis_V_data_V, __xlx_apatb_param_m_axis_V_keep_V, __xlx_apatb_param_m_axis_V_strb_V, __xlx_apatb_param_m_axis_V_last_V);
CodeState = DUMP_OUTPUTS;
long __xlx_apatb_param_s_axis_stream_buf_final_size = __xlx_apatb_param_s_axis_stream_buf_size - ((hls::stream<long long>*)__xlx_apatb_param_s_axis_V_data_V)->size();
aesl_fh.write(AUTOTB_TVIN_s_axis_V_data_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVIN_s_axis_V_keep_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVIN_s_axis_V_strb_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVIN_s_axis_V_last_V, begin_str(AESL_transaction));
for (int j = 0, e = __xlx_apatb_param_s_axis_stream_buf_final_size; j != e; ++j) {
sc_bv<64> __xlx_tmp_0_lv = ((long long*)&__xlx_apatb_param_s_axis_V_data_V_stream_buf[j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_0_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVIN_s_axis_V_data_V, __xlx_sprintf_buffer.data());
sc_bv<8> __xlx_tmp_1_lv = ((char*)&__xlx_apatb_param_s_axis_V_keep_V_stream_buf[j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_1_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVIN_s_axis_V_keep_V, __xlx_sprintf_buffer.data());
sc_bv<8> __xlx_tmp_2_lv = ((char*)&__xlx_apatb_param_s_axis_V_strb_V_stream_buf[j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_2_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVIN_s_axis_V_strb_V, __xlx_sprintf_buffer.data());
sc_bv<1> __xlx_tmp_4_lv = ((char*)&__xlx_apatb_param_s_axis_V_last_V_stream_buf[j])[0];
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_s_axis_V_data_V, end_str());
}

// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_s_axis_V_keep_V, begin_str(AESL_transaction));
if (__xlx_apatb_param_s_axis_stream_buf_final_size > 0) {
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_s_axis_V_keep_V, end_str());
}

// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_s_axis_V_strb_V, begin_str(AESL_transaction));
if (__xlx_apatb_param_s_axis_stream_buf_final_size > 0) {
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_s_axis_V_strb_V, end_str());
}

// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_s_axis_V_last_V, begin_str(AESL_transaction));
if (__xlx_apatb_param_s_axis_stream_buf_final_size > 0) {
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_s_axis_V_last_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_V_data_V, begin_str(AESL_transaction));
...
aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_V_data_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_V_keep_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_s_axis_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_V_keep_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_V_keep_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_V_strb_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_s_axis_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_V_strb_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_V_strb_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_V_last_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_s_axis_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_V_last_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_s_axis_V_last_V, end_str());
}
long __xlx_apatb_param_udpIn_stream_buf_final_size = __xlx_apatb_param_udpIn_stream_buf_size - ((hls::stream<long long>*)__xlx_apatb_param_udpIn_V_data_V)->size();
aesl_fh.write(AUTOTB_TVIN_udpIn_V_data_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVIN_udpIn_V_keep_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVIN_udpIn_V_strb_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVIN_udpIn_V_last_V, begin_str(AESL_transaction));
for (int j = 0, e = __xlx_apatb_param_udpIn_stream_buf_final_size; j != e; ++j) {
sc_bv<64> __xlx_tmp_0_lv = ((long long*)&__xlx_apatb_param_udpIn_V_data_V_stream_buf[j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_0_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVIN_udpIn_V_data_V, __xlx_sprintf_buffer.data());
sc_bv<8> __xlx_tmp_1_lv = ((char*)&__xlx_apatb_param_udpIn_V_keep_V_stream_buf[j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_1_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVIN_udpIn_V_keep_V, __xlx_sprintf_buffer.data());
sc_bv<8> __xlx_tmp_2_lv = ((char*)&__xlx_apatb_param_udpIn_V_strb_V_stream_buf[j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_2_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVIN_udpIn_V_strb_V, __xlx_sprintf_buffer.data());
sc_bv<1> __xlx_tmp_4_lv = ((char*)&__xlx_apatb_param_udpIn_V_last_V_stream_buf[j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_4_lv.to_string(SC_HEX).c_str());
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_udpIn_V_data_V, end_str());
}

// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_udpIn_V_keep_V, begin_str(AESL_transaction));
if (__xlx_apatb_param_udpIn_stream_buf_final_size > 0) {
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_udpIn_V_keep_V, end_str());
}

// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_udpIn_V_strb_V, begin_str(AESL_transaction));
if (__xlx_apatb_param_udpIn_stream_buf_final_size > 0) {
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_udpIn_V_strb_V, end_str());
}

// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_udpIn_V_last_V, begin_str(AESL_transaction));
if (__xlx_apatb_param_udpIn_stream_buf_final_size > 0) {
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_udpIn_V_last_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_udpIn_V_data_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_udpIn_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_udpIn_V_data_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_udpIn_V_data_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_udpIn_V_keep_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_udpIn_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_udpIn_V_keep_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_udpIn_V_keep_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_udpIn_V_strb_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_udpIn_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_udpIn_V_strb_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_udpIn_V_strb_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_udpIn_V_last_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_udpIn_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_udpIn_V_last_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_udpIn_V_last_V, end_str());
}
long __xlx_apatb_param_ttlIn_stream_buf_final_size = __xlx_apatb_param_ttlIn_stream_buf_size - ((hls::stream<long long>*)__xlx_apatb_param_ttlIn_V_data_V)->size();
aesl_fh.write(AUTOTB_TVIN_ttlIn_V_data_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVIN_ttlIn_V_keep_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVIN_ttlIn_V_strb_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVIN_ttlIn_V_last_V, begin_str(AESL_transaction));
for (int j = 0, e = __xlx_apatb_param_ttlIn_stream_buf_final_size; j != e; ++j) {
sc_bv<64> __xlx_tmp_0_lv = ((long long*)&__xlx_apatb_param_ttlIn_V_data_V_stream_buf[j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_0_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVIN_ttlIn_V_data_V, __xlx_sprintf_buffer.data());
sc_bv<8> __xlx_tmp_1_lv = ((char*)&__xlx_apatb_param_ttlIn_V_keep_V_stream_buf[j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_1_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVIN_ttlIn_V_keep_V, __xlx_sprintf_buffer.data());
sc_bv<8> __xlx_tmp_2_lv = ((char*)&__xlx_apatb_param_ttlIn_V_strb_V_stream_buf[j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_2_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVIN_ttlIn_V_strb_V, __xlx_sprintf_buffer.data());
sc_bv<1> __xlx_tmp_4_lv = ((char*)&__xlx_apatb_param_ttlIn_V_last_V_stream_buf[j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_4_lv.to_string(SC_HEX).c_str());
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_ttlIn_V_data_V, end_str());
}

// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_ttlIn_V_keep_V, begin_str(AESL_transaction));
if (__xlx_apatb_param_ttlIn_stream_buf_final_size > 0) {
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_ttlIn_V_keep_V, end_str());
}

// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_ttlIn_V_strb_V, begin_str(AESL_transaction));
if (__xlx_apatb_param_ttlIn_stream_buf_final_size > 0) {
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_ttlIn_V_strb_V, end_str());
}

// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_ttlIn_V_last_V, begin_str(AESL_transaction));
if (__xlx_apatb_param_ttlIn_stream_buf_final_size > 0) {
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_ttlIn_V_last_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_ttlIn_V_data_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_ttlIn_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_ttlIn_V_data_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_ttlIn_V_data_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_ttlIn_V_keep_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_ttlIn_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_ttlIn_V_keep_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_ttlIn_V_keep_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_ttlIn_V_strb_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_ttlIn_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_ttlIn_V_strb_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_ttlIn_V_strb_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_ttlIn_V_last_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_ttlIn_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_ttlIn_V_last_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_ttlIn_V_last_V, end_str());
}

//********************** dump C output stream *******************
long __xlx_apatb_param_m_axis_stream_buf_final_size = ((hls::stream<long long>*)__xlx_apatb_param_m_axis_V_data_V)->size() - __xlx_apatb_param_m_axis_stream_buf_size;
{
  while (!((hls::stream<long long>*)__xlx_apatb_param_m_axis_V_data_V)->empty())
    __xlx_apatb_param_m_axis_V_data_V_stream_buf.push_back(((hls::stream<long long>*)__xlx_apatb_param_m_axis_V_data_V)->read());
  for (int i = 0; i < __xlx_apatb_param_m_axis_V_data_V_stream_buf.size(); ++i)
    ((hls::stream<long long>*)__xlx_apatb_param_m_axis_V_data_V)->write(__xlx_apatb_param_m_axis_V_data_V_stream_buf[i]);
  }
{
  while (!((hls::stream<char>*)__xlx_apatb_param_m_axis_V_keep_V)->empty())
    __xlx_apatb_param_m_axis_V_keep_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_m_axis_V_keep_V)->read());
  for (int i = 0; i < __xlx_apatb_param_m_axis_V_keep_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_m_axis_V_keep_V)->write(__xlx_apatb_param_m_axis_V_keep_V_stream_buf[i]);
  }
{
  while (!((hls::stream<char>*)__xlx_apatb_param_m_axis_V_strb_V)->empty())
    __xlx_apatb_param_m_axis_V_strb_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_m_axis_V_strb_V)->read());
  for (int i = 0; i < __xlx_apatb_param_m_axis_V_strb_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_m_axis_V_strb_V)->write(__xlx_apatb_param_m_axis_V_strb_V_stream_buf[i]);
  }
{
  while (!((hls::stream<char>*)__xlx_apatb_param_m_axis_V_last_V)->empty())
    __xlx_apatb_param_m_axis_V_last_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_m_axis_V_last_V)->read());
  for (int i = 0; i < __xlx_apatb_param_m_axis_V_last_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_m_axis_V_last_V)->write(__xlx_apatb_param_m_axis_V_last_V_stream_buf[i]);
  }
aesl_fh.write(AUTOTB_TVOUT_m_axis_V_data_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVOUT_m_axis_V_keep_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVOUT_m_axis_V_strb_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVOUT_m_axis_V_last_V, begin_str(AESL_transaction));
for (int j = 0, e = __xlx_apatb_param_m_axis_stream_buf_final_size; j != e; ++j) {
sc_bv<64> __xlx_tmp_0_lv = ((long long*)&__xlx_apatb_param_m_axis_V_data_V_stream_buf[__xlx_apatb_param_m_axis_stream_buf_size+j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_0_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVOUT_m_axis_V_data_V, __xlx_sprintf_buffer.data());
sc_bv<8> __xlx_tmp_1_lv = ((char*)&__xlx_apatb_param_m_axis_V_keep_V_stream_buf[__xlx_apatb_param_m_axis_stream_buf_size+j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_1_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVOUT_m_axis_V_keep_V, __xlx_sprintf_buffer.data());
sc_bv<8> __xlx_tmp_2_lv = ((char*)&__xlx_apatb_param_m_axis_V_strb_V_stream_buf[__xlx_apatb_param_m_axis_stream_buf_size+j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_2_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVOUT_m_axis_V_strb_V, __xlx_sprintf_buffer.data());
sc_bv<1> __xlx_tmp_4_lv = ((char*)&__xlx_apatb_param_m_axis_V_last_V_stream_buf[__xlx_apatb_param_m_axis_stream_buf_size+j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_4_lv.to_string(SC_HEX).c_str());
...
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_V_data_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_V_keep_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_m_axis_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_V_keep_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_V_keep_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_V_strb_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_m_axis_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_V_strb_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_V_strb_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_V_last_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_m_axis_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_V_last_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_V_last_V, end_str());
}
