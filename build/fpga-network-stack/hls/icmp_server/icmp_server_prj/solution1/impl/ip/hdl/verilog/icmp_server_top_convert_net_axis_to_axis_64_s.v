...
wire   [63:0] inputWord_data_V_fu_75_p1;
reg   [63:0] inputWord_data_V_reg_101;
reg   [7:0] inputWord_keep_V_reg_106;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_nbreadreq_fu_44_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        inputWord_keep_V_reg_106 <= {{dataOut_internal_dout[71:64]}};
        inputWord_last_V_reg_111 <= dataOut_internal_dout[32'd72];
    end
end
...
assign inputWord_data_V_fu_75_p1 = dataOut_internal_dout[63:0];
