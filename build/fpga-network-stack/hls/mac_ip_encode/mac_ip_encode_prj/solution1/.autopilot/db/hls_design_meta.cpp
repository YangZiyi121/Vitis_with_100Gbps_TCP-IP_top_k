...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("s_axis_arp_lookup_reply_TDATA", 56, hls_in, 4, "axis", "in_data", 1),
	...
	Port_Property("m_axis_arp_lookup_request_TDATA", 32, hls_out, 9, "axis", "out_data", 1),
	...
	Port_Property("m_axis_arp_lookup_request_TVALID", 1, hls_out, 9, "axis", "out_vld", 1),
	Port_Property("m_axis_arp_lookup_request_TREADY", 1, hls_in, 9, "axis", "out_acc", 1),
	Port_Property("s_axis_arp_lookup_reply_TVALID", 1, hls_in, 4, "axis", "in_vld", 1),
	Port_Property("s_axis_arp_lookup_reply_TREADY", 1, hls_out, 4, "axis", "in_acc", 1),
};
