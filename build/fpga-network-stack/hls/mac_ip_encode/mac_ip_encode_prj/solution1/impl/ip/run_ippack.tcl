...
set solution_dir "/home/yangz0e/Desktop/Vitis_with_100Gbps_TCP-IP_top_k/build/fpga-network-stack/hls/mac_ip_encode/mac_ip_encode_prj/solution1"
set debug_dir "/home/yangz0e/Desktop/Vitis_with_100Gbps_TCP-IP_top_k/build/fpga-network-stack/hls/mac_ip_encode/mac_ip_encode_prj/solution1/.debug"
...
set Interfaces {
    ap_clk {
        ...
        buses "s_axis_ip s_axis_arp_lookup_reply m_axis_ip m_axis_arp_lookup_request"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    s_axis_arp_lookup_reply {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_arp_lookup_reply"
        has_tready "1"
        ports {
            TDATA 56
        }
    ...
    m_axis_arp_lookup_request {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_arp_lookup_request"
        has_tready "1"
        ports {
            TDATA 32
        }
...
## System Info
set user_parameters_list {clk_period 3.2 machine 64 combinational 0 latency 19 II x}
