...
attribute shreg_extract : string;
    ...
    signal tmp_27_i_fu_79_p4 : STD_LOGIC_VECTOR (576 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_nbreadreq_fu_34_p6 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_data_V_reg_95 <= s_axis_ip_TDATA_int_regslice;
                tmp_keep_V_reg_100 <= s_axis_ip_TKEEP_int_regslice;
                tmp_last_V_reg_105 <= s_axis_ip_TLAST_int_regslice;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_34_p6, ap_done_reg, dataIn_internal_full_n, tmp_reg_91, s_axis_ip_TVALID_int_regslice)
    begin
    ...
    ap_block_pp0_stage0_11001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_34_p6, ap_done_reg, dataIn_internal_full_n, tmp_reg_91, s_axis_ip_TVALID_int_regslice)
    begin
    ...
    ap_block_pp0_stage0_subdone_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_34_p6, ap_done_reg, dataIn_internal_full_n, tmp_reg_91, s_axis_ip_TVALID_int_regslice)
    begin
    ...
    ap_block_state1_pp0_stage0_iter0_assign_proc : process(tmp_nbreadreq_fu_34_p6, ap_done_reg, s_axis_ip_TVALID_int_regslice)
    begin
    ...
    dataIn_internal_din <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_27_i_fu_79_p4),1024));
    ...
    s_axis_ip_TDATA_blk_n_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, tmp_nbreadreq_fu_34_p6, ap_done_reg, ap_block_pp0_stage0, s_axis_ip_TVALID_int_regslice)
    begin
    ...
    tmp_27_i_fu_79_p4 <= ((tmp_last_V_reg_105 & tmp_keep_V_reg_100) & tmp_data_V_reg_95);
