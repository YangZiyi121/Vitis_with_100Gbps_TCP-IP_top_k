...
module iperf_client_txDataBuffer_handler_512_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_idle;
output   ap_ready;
input  [1023:0] txDataBuffer_dout;
input   txDataBuffer_empty_n;
output   txDataBuffer_read;
...
wire   [511:0] tmp_data_V_fu_75_p1;
reg   [511:0] tmp_data_V_reg_101;
reg   [63:0] tmp_keep_V_reg_106;
reg   [0:0] tmp_last_V_reg_111;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_nbreadreq_fu_44_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_keep_V_reg_106 <= {{txDataBuffer_dout[575:512]}};
        tmp_last_V_reg_111 <= txDataBuffer_dout[32'd576];
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_nbreadreq_fu_44_p3 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        txDataBuffer_read = 1'b1;
    end else begin
        txDataBuffer_read = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_done_reg == 1'b1) | ((tmp_i_nbreadreq_fu_44_p3 == 1'd1) & (txDataBuffer_empty_n == 1'b0)));
end
...
assign tmp_data_V_fu_75_p1 = txDataBuffer_dout[511:0];

assign tmp_i_nbreadreq_fu_44_p3 = txDataBuffer_empty_n;

endmodule //iperf_client_txDataBuffer_handler_512_s
