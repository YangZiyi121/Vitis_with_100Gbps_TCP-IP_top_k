...
entity scatter_rxDataBuffer_handler_512_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of scatter_rxDataBuffer_handler_512_s is 
...
begin
    regslice_both_s_axis_rx_data_V_data_V_U : component scatter_regslice_both
    generic map (
        DataWidth => 512)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_rx_data_V_keep_V_U : component scatter_regslice_both
    generic map (
        DataWidth => 64)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_rx_data_V_strb_V_U : component scatter_regslice_both
    generic map (
        DataWidth => 64)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_rx_data_V_last_V_U : component scatter_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
