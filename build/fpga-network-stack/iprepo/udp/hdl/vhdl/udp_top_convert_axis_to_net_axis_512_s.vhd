...
attribute shreg_extract : string;
    ...
    signal tmp_13_i_fu_79_p4 : STD_LOGIC_VECTOR (576 downto 0);
...
begin
    regslice_both_s_axis_rx_data_V_data_V_U : component udp_top_regslice_both
    generic map (
        DataWidth => 512)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_rx_data_V_keep_V_U : component udp_top_regslice_both
    generic map (
        DataWidth => 64)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_rx_data_V_strb_V_U : component udp_top_regslice_both
    generic map (
        DataWidth => 64)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_rx_data_V_last_V_U : component udp_top_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_34_p6, ap_done_reg, s_axis_rx_data_internal_full_n, tmp_reg_91, s_axis_rx_data_TVALID_int_regslice)
    begin
    ...
    ap_block_pp0_stage0_11001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_34_p6, ap_done_reg, s_axis_rx_data_internal_full_n, tmp_reg_91, s_axis_rx_data_TVALID_int_regslice)
    begin
    ...
    ap_block_pp0_stage0_subdone_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_34_p6, ap_done_reg, s_axis_rx_data_internal_full_n, tmp_reg_91, s_axis_rx_data_TVALID_int_regslice)
    begin
    ...
    s_axis_rx_data_internal_din <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_13_i_fu_79_p4),1024));
    ...
    tmp_13_i_fu_79_p4 <= ((tmp_last_V_reg_105 & tmp_keep_V_reg_100) & tmp_data_V_reg_95);
