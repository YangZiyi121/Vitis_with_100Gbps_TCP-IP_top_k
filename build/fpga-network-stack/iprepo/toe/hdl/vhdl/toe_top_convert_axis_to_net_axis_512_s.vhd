...
attribute shreg_extract : string;
    ...
    signal tmp_160_i_fu_79_p4 : STD_LOGIC_VECTOR (576 downto 0);
    signal ap_NS_fsm : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_idle_pp0_0to0 : STD_LOGIC;
    signal ap_reset_idle_pp0 : STD_LOGIC;
    signal ap_enable_pp0 : STD_LOGIC;
    signal regslice_both_s_axis_tcp_data_V_data_V_U_apdone_blk : STD_LOGIC;
    ...
    signal regslice_both_s_axis_tcp_data_V_data_V_U_ack_in : STD_LOGIC;
    signal regslice_both_s_axis_tcp_data_V_keep_V_U_apdone_blk : STD_LOGIC;
    signal s_axis_tcp_data_TKEEP_int_regslice : STD_LOGIC_VECTOR (63 downto 0);
    signal regslice_both_s_axis_tcp_data_V_keep_V_U_vld_out : STD_LOGIC;
    signal regslice_both_s_axis_tcp_data_V_keep_V_U_ack_in : STD_LOGIC;
    signal regslice_both_s_axis_tcp_data_V_strb_V_U_apdone_blk : STD_LOGIC;
    signal s_axis_tcp_data_TSTRB_int_regslice : STD_LOGIC_VECTOR (63 downto 0);
    signal regslice_both_s_axis_tcp_data_V_strb_V_U_vld_out : STD_LOGIC;
    signal regslice_both_s_axis_tcp_data_V_strb_V_U_ack_in : STD_LOGIC;
    signal regslice_both_s_axis_tcp_data_V_last_V_U_apdone_blk : STD_LOGIC;
    signal s_axis_tcp_data_TLAST_int_regslice : STD_LOGIC_VECTOR (0 downto 0);
    signal regslice_both_s_axis_tcp_data_V_last_V_U_vld_out : STD_LOGIC;
    signal regslice_both_s_axis_tcp_data_V_last_V_U_ack_in : STD_LOGIC;
...
begin
    regslice_both_s_axis_tcp_data_V_data_V_U : component toe_top_regslice_both
    generic map (
        DataWidth => 512)
    port map (
        ap_clk => ap_clk,
        ...
        ack_in => regslice_both_s_axis_tcp_data_V_data_V_U_ack_in,
        ...
        apdone_blk => regslice_both_s_axis_tcp_data_V_data_V_U_apdone_blk);

    regslice_both_s_axis_tcp_data_V_keep_V_U : component toe_top_regslice_both
    generic map (
        DataWidth => 64)
    port map (
        ap_clk => ap_clk,
        ...
        vld_in => s_axis_tcp_data_TVALID,
        ack_in => regslice_both_s_axis_tcp_data_V_keep_V_U_ack_in,
        data_out => s_axis_tcp_data_TKEEP_int_regslice,
        vld_out => regslice_both_s_axis_tcp_data_V_keep_V_U_vld_out,
        ack_out => s_axis_tcp_data_TREADY_int_regslice,
        apdone_blk => regslice_both_s_axis_tcp_data_V_keep_V_U_apdone_blk);

    regslice_both_s_axis_tcp_data_V_strb_V_U : component toe_top_regslice_both
    generic map (
        DataWidth => 64)
    port map (
        ap_clk => ap_clk,
        ...
        vld_in => s_axis_tcp_data_TVALID,
        ack_in => regslice_both_s_axis_tcp_data_V_strb_V_U_ack_in,
        data_out => s_axis_tcp_data_TSTRB_int_regslice,
        vld_out => regslice_both_s_axis_tcp_data_V_strb_V_U_vld_out,
        ack_out => s_axis_tcp_data_TREADY_int_regslice,
        apdone_blk => regslice_both_s_axis_tcp_data_V_strb_V_U_apdone_blk);

    regslice_both_s_axis_tcp_data_V_last_V_U : component toe_top_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
        ...
        vld_in => s_axis_tcp_data_TVALID,
        ack_in => regslice_both_s_axis_tcp_data_V_last_V_U_ack_in,
        data_out => s_axis_tcp_data_TLAST_int_regslice,
        vld_out => regslice_both_s_axis_tcp_data_V_last_V_U_vld_out,
        ack_out => s_axis_tcp_data_TREADY_int_regslice,
        apdone_blk => regslice_both_s_axis_tcp_data_V_last_V_U_apdone_blk);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_nbreadreq_fu_34_p6 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_data_V_reg_95 <= s_axis_tcp_data_TDATA_int_regslice;
                tmp_keep_V_reg_100 <= s_axis_tcp_data_TKEEP_int_regslice;
                tmp_last_V_reg_105 <= s_axis_tcp_data_TLAST_int_regslice;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_34_p6, ap_done_reg, ipRxData_internal_full_n, tmp_reg_91, s_axis_tcp_data_TVALID_int_regslice)
    begin
    ...
    ap_block_pp0_stage0_11001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_34_p6, ap_done_reg, ipRxData_internal_full_n, tmp_reg_91, s_axis_tcp_data_TVALID_int_regslice)
    begin
    ...
    ap_block_pp0_stage0_subdone_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_nbreadreq_fu_34_p6, ap_done_reg, ipRxData_internal_full_n, tmp_reg_91, s_axis_tcp_data_TVALID_int_regslice)
    begin
    ...
    ap_block_state1_pp0_stage0_iter0_assign_proc : process(tmp_nbreadreq_fu_34_p6, ap_done_reg, s_axis_tcp_data_TVALID_int_regslice)
    begin
    ...
    ipRxData_internal_din <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_160_i_fu_79_p4),1024));
    ...
    s_axis_tcp_data_TDATA_blk_n_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, tmp_nbreadreq_fu_34_p6, ap_done_reg, ap_block_pp0_stage0, s_axis_tcp_data_TVALID_int_regslice)
    begin
    ...
    s_axis_tcp_data_TREADY <= regslice_both_s_axis_tcp_data_V_data_V_U_ack_in;
    ...
    tmp_160_i_fu_79_p4 <= ((tmp_last_V_reg_105 & tmp_keep_V_reg_100) & tmp_data_V_reg_95);
